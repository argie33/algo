...
"""
Benchmark Returns Loader - Optimal Pattern.
...
class BenchmarkReturnsLoader(OptimalLoader):
    table_name = "benchmark_returns"
    primary_key = ("benchmark_name", "date")
...
def main():
    parser = argparse.ArgumentParser(description="Optimal benchmark_returns loader")

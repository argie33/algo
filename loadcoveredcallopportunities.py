#!/usr/bin/env python3
"""
Covered Call Opps Loader - Optimal Pattern.
...
class CoveredCallOppsLoader(OptimalLoader):
    table_name = "covered_call_opps"
...
def main():
    parser = argparse.ArgumentParser(description="Optimal covered_call_opps loader")

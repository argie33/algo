...
class ThresholdConfig:
    ...
    def _get_config_value(key: str, default):
        ...
        try:
            ...
            logger.debug(f"_get_config_value({key}) failed: {e} — using default {default}")
            return default
    ...
    def get_data_staleness_days(is_monday: bool) -> int:
        ...
        """
        return ThresholdConfig.data_staleness_stale_days_monday() if is_monday else ThresholdConfig.data_staleness_stale_days_other()
    ...
    def get_rate_limit_threshold(is_eod_pipeline: bool) -> int:
        ...
        """
        return ThresholdConfig.loader_rate_limit_circuit_break_threshold_eod() if is_eod_pipeline else ThresholdConfig.loader_rate_limit_circuit_break_threshold_morning()

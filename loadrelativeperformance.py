#!/usr/bin/env python3
"""
Relative Performance Loader - Optimal Pattern.

Inherits watermarks, dedup, multi-source routing, parallelism, and bulk COPY.

Run:
    python3 loadrelativeperformance.py [--symbols AAPL,MSFT] [--parallelism 8]
"""
...
class RelativePerformanceLoader(OptimalLoader):
    table_name = "relative_performance"
...
def main():
    parser = argparse.ArgumentParser(description="Optimal relative_performance loader")
    ...
    loader = RelativePerformanceLoader()
    try:

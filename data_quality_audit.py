...
def audit_price_data():
    ...
    # Check for NULL closes (critical)
...
def audit_buy_signals():
    ...
    # Check for NULL entry prices (CRITICAL ERROR)
    ...
    # Check RSI has NaN values (not an error, just informational)
    ...
    # Critical errors only (NULL entry prices is critical)

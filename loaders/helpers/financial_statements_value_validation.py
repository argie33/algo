...
# candidate (100), well outside this tolerance, while ATHE's real ADS ratio measured 100.04x/
# 99.24x/100.00x across 3 separate fiscal years (well inside it). Candidates are the ADS
# ratios actually seen in practice, not "any integer" - matching any integer would also
# admit NRC (96.53 rounds to 97, only 0.48% away).
                ...
                if has_net_income:
                    ...
                    if reported_shares is not None and float(reported_shares) > 0:
                        ...
                        if shares_ratio > max_implied_vs_reported_shares_ratio:
                            ...
                            # Ratio held at ~100x across 3 separate fiscal years (99.24/100.00/

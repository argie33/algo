        ...
        with handle_db_errors("validate_upstream_metrics"):
            with DatabaseContext("read") as cur:
                ...
                required_metric_tables = {
                    "value_metrics": 0.70,  # Session 255: Restored to 70% with yfinance fallback (was 1% without fallback)
                    "growth_metrics": 0.50,  # SEC-filing dependent but majority should have some data
                    "positioning_metrics": 0.70,  # Session 255: Restored to 70% with yfinance fallback (was 0% without fallback)
                    "stability_metrics": 0.70,  # Beta calculation requires price history
                }

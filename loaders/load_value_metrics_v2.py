...
Result: Eliminates 6x redundant API calls, prevents rate limiting, parallelism can be 4+ instead of 1.
"""
            ...
            return [
                {
                    ...
                    "held_percent_insiders": None,  # Now in positioning_metrics_snapshot
                    "held_percent_insiders_unavailable_reason": "moved_to_positioning_metrics",
                    "held_percent_institutions": None,  # Now in positioning_metrics_snapshot

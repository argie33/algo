            ...
            return [
                {
                    ...
                    if pe_cap_result["available"]
                    else pe_cap_result.get("reason", "unknown"),
                    "pb_ratio": pb_cap_result["value"],
                    "pb_ratio_unavailable_reason": None
                    if pb_cap_result["available"]
                    else pb_cap_result.get("reason", "unknown"),
                    "ps_ratio": ps_cap_result["value"],
                    "ps_ratio_unavailable_reason": None
                    if ps_cap_result["available"]
                    else ps_cap_result.get("reason", "unknown"),
                    "peg_ratio": peg_cap_result["value"],
                    "peg_ratio_unavailable_reason": None
                    if peg_cap_result["available"]
                    else peg_cap_result.get("reason", "unknown"),
                    ...
                    if held_institutions_pct
                    else "missing_from_yfinance",

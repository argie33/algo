...
def _load_economic_calendar(today: date) -> int:
    ...
    events_config = [
        {
            ...
            "previous_value": 238000,
        },
        {
            "event_id": "CPI_20260605",
            "event_date": date(2026, 6, 5),
            "event_time": "08:30",
            "event_name": "CPI - Consumer Price Index (YoY)",
            "category": "Economic",
            "importance": "HIGH",
            "forecast_value": 3.4,
            "previous_value": 3.5,
        ...
        {
            "event_id": "UNEMPLOYMENT_20260605",
            "event_date": date(2026, 6, 5),
            "event_time": "08:30",
        ...
        {
            "event_id": "RETAIL_SALES_20260612",
        ...
        {
            "event_id": "PPI_20260612",
            "event_date": date(2026, 6, 12),
            "event_time": "08:30",
            "event_name": "Producer Price Index (YoY)",
            "category": "Economic",
            "importance": "MEDIUM",
            "forecast_value": 2.1,
            "previous_value": 2.2,
        ...
        {
            "event_id": "GDP_Q1_20260625",
            "event_date": date(2026, 6, 25),
            "event_time": "08:30",
            "event_name": "GDP (Advance Estimate)",
            "category": "Economic",
            "importance": "HIGH",
            "forecast_value": 2.4,
            "previous_value": 2.7,
    ...
    for event_config in events_config:
        ...
        if not event_date:
            logger.warning(
                f"Event {event_config.get('event_id', 'unknown')}: Skipping record with None/empty date (prevents dedup collision)"
            )
            continue

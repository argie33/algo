...
from monitoring_alerting import MonitoringSystem, AlertSeverity
...
def main():
    ...
    for symbol in ['AAPL', 'MSFT']:
        ...
        print(f"  Issues: {dq_result['summary']['critical_issues']} critical, {dq_result['summary']['warnings']} warnings")
    ...
    print(f"Alerts (24h): {alert_summary['total_alerts']} total, {alert_summary['active_alerts']} active")

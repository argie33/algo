...
async function testLogin() {
  ...
  try {
    ...
    console.log('📱 First: Navigating to home to initialize page...');
    try {
    ...
    console.log('🧹 Clearing devAuth session via sessionStorage...');
    await page.evaluate(() => {
      // Clear dev auth sessions
      sessionStorage.removeItem('devAuth_session');
      sessionStorage.removeItem('devAuth_users');
    ...
    if (!usernameExists || !passwordExists) {
      ...
      const domInfo = await page.evaluate(() => ({
        ...
        hasAuthModal: !!document.querySelector('.card.animate-in'),

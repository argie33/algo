#!/usr/bin/env python3
"""
News Sentiment Loader - Optimal Pattern.

Inherits watermarks, dedup, multi-source routing, parallelism, and bulk COPY.

Run:
    python3 loadnews.py [--symbols AAPL,MSFT] [--parallelism 8]
"""
...
class NewsSentimentLoader(OptimalLoader):
    table_name = "news_sentiment"
    primary_key = ("symbol", "publish_date")
...
def main():
    parser = argparse.ArgumentParser(description="Optimal news_sentiment loader")

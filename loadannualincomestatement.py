...
def load_annual_income_statement(symbols, cur, conn):
    total = len(symbols)
...
if __name__ == "__main__":
    ...
    sample_income_statement = sample_ticker.financials
    ...
    if sample_income_statement is not None and not sample_income_statement.empty:
        ...
        conn.commit()
        logging.info("Created annual income statement table with dynamic columns")
    else:

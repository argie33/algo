...
_DEFAULTS = [
    ...
    ('rs_slope_gate_enabled', 'false', 'bool', 'Hard-gate T3 on RS line trending up (set false during strong SPY runs)'),
    ('volume_decay_gate_enabled', 'false', 'bool', 'Hard-gate T3 on volume decay into breakout (set false to soften)'),
    # Exit Rules

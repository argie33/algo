-- Migration 076: Add swing_score to algo_positions_with_risk view
-- The Swing column in positions dashboard was always "--" because the view
-- didn't join swing_trader_scores. Now we pull the latest score per symbol.

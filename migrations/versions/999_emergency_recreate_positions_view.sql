-- ════════════════════════════════════════════════════════════════════════════
-- MIGRATION: 999_emergency_recreate_positions_view
-- ════════════════════════════════════════════════════════════════════════════
--
-- PURPOSE: Emergency recreation of algo_positions_with_risk materialized view
--
-- ISSUE: Dashboard positions API returns only 1 position when 10+ exist in database.
-- ROOT CAUSE: The materialized view algo_positions_with_risk was missing from RDS.
-- This view is CRITICAL for the /api/algo/positions endpoint.
--
-- SOLUTION: Recreate the view with CORRECT definition (not simplified):
-- - Joins with price_daily for current prices
-- - Joins with algo_trades for stop/target levels and sector
-- - Joins with trend_template_data for technical scores
-- - Calculates r_multiple, risk per share, distance to targets
-- - Handles NULLs properly (fail-fast on missing data)
--
-- CREATED: 2026-07-04

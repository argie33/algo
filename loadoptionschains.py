#!/usr/bin/env python3
"""
Option Chains Loader - Optimal Pattern.

Inherits watermarks, dedup, multi-source routing, parallelism, and bulk COPY.

Run:
    python3 loadoptionschains.py [--symbols AAPL,MSFT] [--parallelism 8]
"""
...
class OptionChainsLoader(OptimalLoader):
...
def main():
    parser = argparse.ArgumentParser(description="Optimal option_chains loader")

...
# ongoing 24/7 Fargate cost - deliberately left false here, needs explicit sign-off before
# deploying.
...
# SECURITY (2026-09-09): genuinely independent of alpaca_paper_trading above by design - the
# executor requires ALGO_LIVE_TRADING, ALPACA_PAPER_TRADING, and APCA_API_BASE_URL to all three
# separately agree before it will place a real order (see algo/trading/executor_strategies.py's
# AutoExecutionMode). Leave empty here always; set via TF_VAR_algo_live_trading_ack (NOT in this
# committed file) only at the deliberate moment of going live.
algo_live_trading_ack = ""

...
algo_lambda_reserved_concurrency    = 5     # FIXED: Must be >= provisioned concurrency. AWS Lambda constraint. Set to 5 for safety margin on scheduled runs. Cost negligible.

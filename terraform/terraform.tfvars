...
algo_lambda_timeout    = 180  # Temporarily increased to 180s to capture full execution for profiling. Market exposure cached, but database access still contributes to runtime.

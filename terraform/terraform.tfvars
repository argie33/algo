...
algo_lambda_provisioned_concurrency = 2     # FIXED: Ensures reliable scheduled orchestrator execution. Cost: ~$2.40/month. Pre-warmed instances prevent execution delays.
algo_lambda_reserved_concurrency    = 10    # FIXED: Must be >= provisioned concurrency. AWS Lambda constraint: ReservedConcurrentExecutions must be >= provisioned. Increased from 2 to 10 to comply with constraint. Cost ~$1-2/month.

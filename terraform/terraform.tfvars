...
algo_lambda_timeout    = 120  # Reduced from 900s: market exposure now cached (0 queries intraday), 7 phases = 30-60s typical + margin. RDS Proxy eliminates disk I/O contention

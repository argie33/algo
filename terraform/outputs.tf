...
# ============================================================
# These MUST be uncommented and active. GitHub Actions deploy-code.yml
# reads these outputs via: terraform output -json
# Without these, frontend config.js gets empty Cognito IDs → auth fails with 429
# ============================================================

...
class LambdaAPIClient:
    ...
    def invoke(self, path: str, method: str = "GET", query_params: dict[str, Any] | None = None) -> dict[str, Any]:
        """
...
def invoke_api(path: str, method: str = "GET", query_params: dict[str, Any] | None = None) -> dict[str, Any]:

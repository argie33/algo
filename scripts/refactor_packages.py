...
ALGO_FILES_TO_MOVE = [
    ...
    ('algo/algo_signal_trade_performance.py', 'algo/signals/trade_performance.py', 'signals'),
    ...
    # monitoring
    ('algo/algo_position_monitor.py', 'algo/monitoring/position_monitor.py', 'monitoring'),
    ('algo/algo_pipeline_health.py', 'algo/monitoring/pipeline_health.py', 'monitoring'),
    ('algo/algo_connection_monitor.py', 'algo/monitoring/connection_monitor.py', 'monitoring'),
    ...
    # orchestration
    ('algo/algo_orchestrator.py', 'algo/orchestration/orchestrator.py', 'orchestration'),
    ('algo/algo_regime_manager.py', 'algo/orchestration/regime_manager.py', 'orchestration'),
    ('algo/algo_weight_optimizer.py', 'algo/orchestration/weight_optimizer.py', 'orchestration'),
    # infrastructure
    ('algo/algo_config.py', 'algo/infrastructure/config.py', 'infrastructure'),
    ('algo/algo_trade_audit_logger.py', 'algo/infrastructure/audit_logger.py', 'infrastructure'),
    ('algo/algo_daily_reconciliation.py', 'algo/infrastructure/reconciliation.py', 'infrastructure'),
    ('algo/algo_market_calendar.py', 'algo/infrastructure/market_calendar.py', 'infrastructure'),
    ('algo/algo_market_events.py', 'algo/infrastructure/market_events.py', 'infrastructure'),
    ('algo/algo_realtime_prices.py', 'algo/infrastructure/realtime_prices.py', 'infrastructure'),
]
...
UTILS_FILES_TO_MOVE = [
    ...
    ('utils/orchestrator_execution_tracker.py', 'utils/logging/execution_tracker.py', 'logging'),
    ...
    ('utils/validation_integration.py', 'utils/validation/integration.py', 'validation'),
    ...
    ('utils/data_freshness_config.py', 'utils/validation/freshness_config.py', 'validation'),
    ('utils/schema_validator.py', 'utils/validation/schema.py', 'validation'),
    ('utils/financial_data_validator.py', 'utils/validation/financial.py', 'validation'),
    ...
    ('utils/aws_production_config_validator.py', 'utils/validation/aws_config.py', 'validation'),
    # data
    ...
    ('utils/filter_rejection_tracker.py', 'utils/trading/rejection_tracker.py', 'trading'),
    ...
    ('utils/loader_conflict_detector.py', 'utils/loaders/conflict_detector.py', 'loaders'),
    # external
    ...
    # infrastructure
    ('utils/safe_data_conversion.py', 'utils/infrastructure/conversion.py', 'infrastructure'),
    ('utils/timezone_utils.py', 'utils/infrastructure/timezone.py', 'infrastructure'),
    ('utils/url_validator.py', 'utils/infrastructure/url_validator.py', 'infrastructure'),
    ('utils/csv_sanitizer.py', 'utils/infrastructure/csv_sanitizer.py', 'infrastructure'),
    ('utils/execution_timeout.py', 'utils/infrastructure/timeout.py', 'infrastructure'),
    ('utils/correlation_context.py', 'utils/infrastructure/correlation.py', 'infrastructure'),
    ('utils/market_timing_constants.py', 'utils/infrastructure/market_timing.py', 'infrastructure'),
    ('utils/feature_flags.py', 'utils/infrastructure/feature_flags.py', 'infrastructure'),
    ('utils/fallback_registry.py', 'utils/infrastructure/fallback_registry.py', 'infrastructure'),
    ('utils/api_endpoints.py', 'utils/infrastructure/api_endpoints.py', 'infrastructure'),
    # ops

...
-- Create price_daily table (used by loadpricedaily)
...
-- Create etf_price_daily table (used by loadpricedaily)
...
-- Create price_monthly table (used by loadpricemonthly)
...
-- Create technicals_daily table (used by loadtechnicalsdaily)
...
-- Create technicals_monthly table (used by loadtechnicalsmonthly)
CREATE TABLE IF NOT EXISTS technicals_monthly (
    id SERIAL PRIMARY KEY,
    symbol VARCHAR(50) NOT NULL,
    date DATE NOT NULL,

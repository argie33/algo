...
DASHBOARD_ENDPOINTS = {
    ...
    "cfg": {
        ...
        "response_schema": ResponseSchema(
            ...
            optional_fields=[
                ...
                "max_hold_days",
                "max_percent_from_52w_high",
                "max_positions_per_industry",
                "max_reentries_per_name",
                "max_rs_pct_from_60d_high",
                "max_short_interest_pct",
                "max_signal_age_days",
                "max_spread_pct",
                ...
                "require_stock_stage_2",
                "require_target_pullback",
                "require_weekly_stage_2",
    ...
    "srank": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["items", "data_freshness", "limit", "page", "total"],
            field_types={
                "items": list,
                "limit": int,
                "page": int,
            ...
            description="Sector rankings with pagination",
        ),
        "freshness_max_age_seconds": 3600,
        "strict_fields": [],
        "critical": False,
    ...
    "sec_rot": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["items", "total", "date", "signal", "strength", "details"],
            field_types={
                "signal": str,
                "strength": (float, int),
                "items": list,
    ...
    "audit": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["items", "limit", "offset", "total"],
            field_types={"items": list, "limit": int, "offset": int, "total": int},
    ...
    "exec_hist": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["items", "limit", "total"],
            field_types={"items": list, "limit": int, "total": int},

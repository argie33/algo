...
_COVERAGE_CATEGORY_RULES: list[tuple[str, set[str]]] = [
    ...
    (
        "Legitimate / not applicable",
        {
            ...
            # applicable" class as structural_accounting_difference just above, distinct reason string since
            ...
            # real business-model fact as structural_accounting_difference just above, not an extraction

...
def handle(
    ...
    if method != "POST":
        return cast(dict[str, Any], error_response(405, "method_not_allowed", "Only POST is supported"))

    if not body:
        return cast(dict[str, Any], error_response(400, "missing_body", "Request body required"))

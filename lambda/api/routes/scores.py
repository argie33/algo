    ...
    try:
        ...
        def _build_factor_inputs(d: dict[str, Any]) -> None:
            ...
            d["quality_inputs"] = {
                ...
                "roic_pct_unavailable_reason": d.get("roic_pct_unavailable_reason"),
                "gross_margin_pct": d.get("gross_margin_pct"),
                "gross_margin_unavailable_reason": d.get("gross_margin_unavailable_reason"),
                ...
                "ebitda_margin_unavailable_reason": d.get("ebitda_margin_unavailable_reason"),
                ...
                "ocf_to_net_income_unavailable_reason": d.get("ocf_to_net_income_unavailable_reason"),

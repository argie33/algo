...
-- ════════════════════════════════════════════════════════════════════════════
-- MISSING TABLES (referenced by API routes but not previously in schema)
-- ════════════════════════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS backtest_runs (
    ...
    expectancy_per_trade DECIMAL(8,4),
    total_return_pct DECIMAL(8,4),
    max_drawdown_pct DECIMAL(8,4),
    sharpe DECIMAL(8,4),
    sortino DECIMAL(8,4),
...
CREATE TABLE IF NOT EXISTS backtest_trades (
    ...
    run_id INTEGER REFERENCES backtest_runs(run_id) ON DELETE CASCADE,
    symbol VARCHAR(20),
    signal_date DATE,
    exit_date DATE,

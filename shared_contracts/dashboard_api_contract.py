...
DASHBOARD_ENDPOINTS = {
    ...
    "cfg": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=[],  # Config returns dynamic fields, skip strict validation
            field_types={},  # No strict type checking for config
            nested_schema={"*": dict},  # Allow any field names

...
DASHBOARD_ENDPOINTS = {
    "run": {
        ...
        "response_schema": ResponseSchema(
            ...
            optional_fields=["halted", "errored", "summary", "halt_reason", "phases_completed", "phases_halted", "phases_errored", "phase_results"],
            field_types={
                "run_id": (str, int),
                "completed_at": str,
                "started_at": str,
    ...
    "mkt": {
        ...
        "response_schema": ResponseSchema(
            ...
            optional_fields=["timestamp", "last_updated", "exposure_pct", "regime", "halt_reasons",
                           "market_stage", "market_trend", "distribution_days_4w", "spy_change_pct",
                           "up_volume_percent", "advance_decline_ratio", "new_highs_count",
                           "new_lows_count", "put_call_ratio", "breadth_momentum_10d",
    ...
    "port": {
        ...
        "response_schema": ResponseSchema(
            ...
            optional_fields=["last_run", "total_buying_power", "daily_return_pct",
                           "unrealized_pnl_pct", "cumulative_return_pct", "max_drawdown_pct",
                           "largest_position_pct", "data_age_seconds"],
            field_types={
    ...
    "perf": {
        ...
        "response_schema": ResponseSchema(
            ...
            optional_fields=["timestamp", "last_updated", "win_rate_pct", "open_positions",
                           "total_pnl_dollars", "unrealized_pnl", "current_streak",
                           "sharpe_annualized", "max_drawdown_pct", "avg_win_pct", "avg_loss_pct",
                           "profit_factor", "expectancy_r", "equity_vals", "recent_rets"],
            field_types={
                "total_trades": int,
                "winning_trades": int,
                "losing_trades": int,
    ...
    "sig": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["n", "total", "buy_sigs", "grades", "near", "top_a", "trend"],
            field_types={
                "n": int,
                "total": int,
                "buy_sigs": list,
    ...
    "activity": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["items", "run_id", "run_at", "phases", "recent_actions", "total"],
            field_types={
                "items": list,
            },
    ...
    "exp_factors": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["factor_quality", "current_exposure_pct", "regime", "factors"],
            field_types={
    ...
    "eco": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["t10", "t2", "t3m", "t6m", "yc_10_2", "yc_10_3m", "hy", "ig",
                           "oil", "nfci", "fed_funds", "cpi_yoy", "unrate", "be10", "be5",
                           "dxy", "mortgage", "umcsent", "items"],
            field_types={
                "t10": (float, int),
                "items": list,
            },
    ...
    "risk": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["report_date", "var_pct_95", "cvar_pct_95", "stressed_var_pct",
    ...
    "perf_anl": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["rolling_sharpe_252d", "rolling_sortino_252d", "calmar_ratio",
    ...
    "sig_eval": {
        ...
        "response_schema": ResponseSchema(
            required_fields=[],
            optional_fields=["total", "t1", "t2", "t3", "t4", "t5", "avg_score", "signal_date", "rejected"],
            field_types={
                "total": int,
                "t1": int,
            },
...
class EndpointRegistry:
    ...
    def get_critical_endpoints() -> Dict[str, Dict[str, Any]]:
        ...
        return {k: v for k, v in DASHBOARD_ENDPOINTS.items() if v.get("critical", False)}

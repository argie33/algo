#!/usr/bin/env python3
"""
Seasonality Loader - Optimal Pattern.
...
class SeasonalityLoader(OptimalLoader):
    table_name = "seasonality"
...
def main():
    parser = argparse.ArgumentParser(description="Optimal seasonality loader")

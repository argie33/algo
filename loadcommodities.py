#!/usr/bin/env python3
"""
Commodities Loader - Optimal Pattern.

Inherits watermarks, dedup, multi-source routing, parallelism, and bulk COPY.

Run:
    python3 loadcommodities.py [--symbols AAPL,MSFT] [--parallelism 8]
"""
...
class CommoditiesLoader(OptimalLoader):
    table_name = "commodities"
    primary_key = ("commodity", "date")
...
def main():
    parser = argparse.ArgumentParser(description="Optimal commodities loader")

 ...
 * Focuses on component-level integration rather than full user journeys
 */

const { test, expect } = require('@playwright/test');

test.describe('Component Integration Tests - Real Backend', () => {
  ...
  test.describe('Dashboard Component Integration', () => {
    ...
    test('Portfolio Summary Component Integration @critical', async ({ page }) => {
    ...
    test('Market Overview Widget Integration @critical', async ({ page }) => {
    ...
    test('Watchlist Component Integration @critical', async ({ page }) => {
  ...
  test.describe('Portfolio Page Components Integration', () => {

    test('Portfolio Holdings Table Integration @critical', async ({ page }) => {
    ...
    test('Portfolio Performance Chart Integration @critical', async ({ page }) => {
  ...
  test.describe('Stock Detail Page Components Integration', () => {

    test('Stock Chart Component Integration @critical', async ({ page }) => {
    ...
    test('Stock News Component Integration @critical', async ({ page }) => {
    ...
    test('Technical Analysis Component Integration @critical', async ({ page }) => {
  ...
  test.describe('Settings Page Components Integration', () => {

    test('API Keys Management Integration @critical', async ({ page }) => {
    ...
    test('User Preferences Integration @critical', async ({ page }) => {
  ...
  test.describe('Trading Components Integration', () => {

    test('Trading Signals Component Integration @critical', async ({ page }) => {
  ...
  test.describe('Real-time Data Components Integration', () => {

    test('Live Price Updates Integration @critical @realtime', async ({ page }) => {
    ...
    test('Market Status Integration @critical', async ({ page }) => {

 ...
 * Validates API responses, error handling, and data consistency
 */

const { test, expect } = require('@playwright/test');

test.describe('API Integration Tests - Real Backend Systems', () => {
  ...
  test.describe('Authentication API Integration', () => {
    ...
    test('Login API Integration @critical', async ({ request }) => {
    ...
    test('Token Validation API Integration @critical', async ({ request }) => {
    ...
    test('Logout API Integration @critical', async ({ request }) => {
  ...
  test.describe('Portfolio API Integration', () => {
    ...
    test('Portfolio Holdings API Integration @critical', async ({ request }) => {
    ...
    test('Portfolio Performance API Integration @critical', async ({ request }) => {
    ...
    test('Portfolio Historical Performance API Integration @critical', async ({ request }) => {
  ...
  test.describe('Market Data API Integration', () => {
    ...
    test('Stock Quote API Integration @critical', async ({ request }) => {
    ...
    test('Stock Historical Data API Integration @critical', async ({ request }) => {
    ...
    test('Market Overview API Integration @critical', async ({ request }) => {
    ...
    test('Sector Performance API Integration @critical', async ({ request }) => {
  ...
  test.describe('Trading API Integration', () => {
    
    test('Trading Account Status API Integration @critical', async ({ request }) => {
    ...
    test('Trading Signals API Integration @critical', async ({ request }) => {
  ...
  test.describe('News and Analysis API Integration', () => {
    
    test('Stock News API Integration @critical', async ({ request }) => {
    ...
    test('Market News API Integration @critical', async ({ request }) => {
    ...
    test('Technical Analysis API Integration @critical', async ({ request }) => {
  ...
  test.describe('API Error Handling Integration', () => {
    ...
    test('Invalid Symbol Error Handling @critical', async ({ request }) => {
      console.log('❌ Testing Invalid Symbol Error Handling...');
      
      const response = await apiCall(request, 'GET', '/api/stocks/INVALID123/quote').catch(async () => {
        // If request throws, make direct request to check error response
        return await request.get(`${testConfig.apiURL}/api/stocks/INVALID123/quote`);
      });
    ...
    test('Unauthorized Access Error Handling @critical', async ({ request }) => {
    ...
    test('Rate Limiting Error Handling @critical', async ({ request }) => {
  ...
  test.describe('API Performance Integration', () => {
    
    test('API Response Time Performance @performance', async ({ request }) => {
    ...
    test('Concurrent API Requests Performance @performance', async ({ request }) => {

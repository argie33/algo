...
- generic [ref=e3]:
  ...
  - main [ref=e146]:
    - alert [ref=e150]:
      - img [ref=e152]
      - generic [ref=e154]: Unable to load user information. This may be due to an expired session or authentication issue.
      - button "Refresh page to re-authenticate" [ref=e156] [cursor=pointer]: Refresh
```
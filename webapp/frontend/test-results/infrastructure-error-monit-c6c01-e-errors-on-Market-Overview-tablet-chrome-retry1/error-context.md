...
- generic [ref=e3]:
  ...
  - main [ref=e146]:
    - generic [ref=e149]:
      - heading "Market Overview" [level=4] [ref=e150]
      - alert [ref=e151]:
        - img [ref=e153]
        - generic [ref=e155]:
          - text: Failed to load market data. Please check your data sources and try again.
          - generic [ref=e156]: "Technical details: Failed to fetch market overview: Network Error"
          - generic [ref=e157]:
            - text: "Debug endpoint:"
            - code [ref=e158]: http://localhost:5001/market/debug
```
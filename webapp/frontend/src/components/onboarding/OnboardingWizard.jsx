...
const OnboardingWizard = ({ open, onClose, onComplete }) => {
  ...
  const validateApiKeys = () => {
    ...
    const hasAnyKey = apiKeys.alpaca.key || apiKeys.polygon.key || apiKeys.finnhub.key;
    ...
    if (apiKeys.alpaca.key && !apiKeys.alpaca.secret) {
      newErrors.alpaca_secret = 'Alpaca secret is required when key is provided';
    }
  ...
  const WelcomeStep = () => (
    <Box>
      ...
      <Typography variant="body1" paragraph>
        This powerful platform provides institutional-grade financial analysis tools 
        that were previously only available to hedge funds and investment banks.
      </Typography>
      ...
      <Alert severity="info" sx={{ mt: 2 }}>
        This setup will take about 5 minutes and will greatly enhance your experience.
      </Alert>
    </Box>
  );
  ...
  const ApiKeysStep = () => (
    <Box>
      ...
      <Typography variant="body2" color="text.secondary" paragraph>
        To provide personalized analysis and portfolio tracking, we need to connect 
        to your brokerage account. Your API keys are encrypted and stored securely.
      </Typography>
      ...
      <Accordion defaultExpanded>
        ...
        <AccordionDetails>
          <Typography variant="body2" color="text.secondary" paragraph>
            Connect to Alpaca for commission-free stock trading and portfolio management.
            <Link href="https://alpaca.markets/docs/api-documentation/" target="_blank" sx={{ ml: 1 }}>
          ...
          <TextField
            ...
            onChange={(e) => handleApiKeyChange('alpaca', 'key', e.target.value)}
          ...
          <TextField
            ...
            onChange={(e) => handleApiKeyChange('alpaca', 'secret', e.target.value)}
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography variant="body2" color="text.secondary" paragraph>
            ...
            <Link href="https://polygon.io/dashboard/api-keys" target="_blank" sx={{ ml: 1 }}>
          ...
          <TextField
            ...
            onChange={(e) => handleApiKeyChange('polygon', 'key', e.target.value)}
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography variant="body2" color="text.secondary" paragraph>
            ...
            <Link href="https://finnhub.io/dashboard" target="_blank" sx={{ ml: 1 }}>
              Get API Key <OpenInNew fontSize="small" />
            </Link>
          </Typography>
          ...
          <TextField
            ...
            onChange={(e) => handleApiKeyChange('finnhub', 'key', e.target.value)}
      ...
      <Alert severity="warning" sx={{ mt: 2 }}>
        <Typography variant="body2">
          <strong>Security Note:</strong> API keys are encrypted using bank-level security 
          before storage. We never store them in plain text.
        </Typography>
      </Alert>
    </Box>
  );
  ...
  const PreferencesStep = () => (
    <Box>
      ...
      <Typography variant="body2" color="text.secondary" paragraph>
        Tell us about your investment preferences to provide personalized recommendations.
      </Typography>
      ...
      <Box sx={{ mb: 3 }}>
        <FormControl fullWidth>
          ...
          >
            <MenuItem value="conservative">Conservative - Prefer stable returns</MenuItem>
            <MenuItem value="moderate">Moderate - Balanced risk/reward</MenuItem>
            <MenuItem value="aggressive">Aggressive - Higher risk for higher returns</MenuItem>
          </Select>
        </FormControl>
      </Box>
      ...
      <Box sx={{ mb: 3 }}>
        <FormControl fullWidth>
          ...
          <Select
            ...
            onChange={(e) => setPreferences(prev => ({ ...prev, investmentStyle: e.target.value }))}
          >
    ...
    <Box>
      ...
      <Card sx={{ mt: 2, backgroundColor: 'primary.light', color: 'primary.contrastText' }}>
        <CardContent>
          ...
          <Typography variant="body2">
            Start by exploring the Dashboard and Stock Analysis pages. 
            Use the search function to analyze your current holdings or stocks you're interested in.
          </Typography>
        </CardContent>
      </Card>
    </Box>
  ...
  const renderStepContent = (step) => {
    switch (step) {
      ...
      case 1: return <ApiKeysStep />;
      case 2: return <PreferencesStep />;
      case 3: return <FeaturesTourStep />;

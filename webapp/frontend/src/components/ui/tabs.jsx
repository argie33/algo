...
export const TabsTrigger = React.forwardRef(({ className, value, children, ...props }, ref) => (
  <button ref={ref} className={className || "px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent hover:border-gray-300"} value={value} {...props}>
    {children}
  </button>
));

 ...
 */
export const QuerySection = ({ loading, error, isEmpty, children, section, onRetry }) => {
  if (error) {
  ...
  if (loading) {
    return (
      <div className="card">
        <div className="card-body">
          <div className="t-xs muted">Loading {section?.toLowerCase() || 'data'}…</div>
        </div>
      </div>
    );
  }
  ...
  if (isEmpty) {
    return (
      <div className="card">
        <div className="card-body">
          <div className="t-xs muted">No {section?.toLowerCase() || 'data'} available</div>
        </div>
      </div>
    );
  }

...
const LiveDataAdmin = () => {
  ...
  const getPerformanceIndicator = (value, threshold) => {
    if (value < threshold * 0.7)
      return { color: "success", icon: <TrendingUpIcon /> };
    if (value < threshold * 0.9)
      return { color: "warning", icon: <TrendingUpIcon /> };
              ...
              <Card elevation={3}>
                <CardContent>
                  ...
                  <LinearProgress
                    ...
                    color={
                      dashboardData?.limits?.connections?.usage > 80
                        ? "error"
                        : "primary"
                    }
                    sx={{ mt: 1 }}
              ...
              <Card elevation={3}>
                <CardContent>
                  ...
                  <LinearProgress
                    ...
                    color={
                      dashboardData?.limits?.cost?.usage > 80
                        ? "error"
                        : "primary"
                    }
                    sx={{ mt: 1 }}
                ...
                <CardContent>
                  ...
                  >
                    <Box>
                      ...
                      <Typography variant="body2" color="textSecondary">
                        subscribers:{" "}
                        {dashboardData?.global?.totalSubscribers || 0}
                      </Typography>
                    </Box>
                ...
                <CardContent>
                  ...
                  >
                    <Box>
                      ...
                      <Typography variant="h4" component="div">
                        {(dashboardData?.global?.performance?.avg || 0).toFixed(
                          0
                        )}
                        ms
                      </Typography>
                      <Typography variant="body2" color="textSecondary">
                        P95:{" "}
                        {(dashboardData?.global?.performance?.p95 || 0).toFixed(
                          0
                        )}
                        ms
                      </Typography>
                ...
                <Table>
                  ...
                  <TableBody>
                    {dashboardData?.providers &&
                      Object.entries(dashboardData.providers).map(
                        ([key, provider]) => (
                          <TableRow key={key}>
                            <TableCell>
                            ...
                            <TableCell align="right">
                              ...
                              >
                                ...
                                {
                                  getPerformanceIndicator(provider.latency, 100)
                                    .icon
                                }
                              </Box>
                            </TableCell>

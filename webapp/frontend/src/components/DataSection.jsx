...
export function DataSection({
  ...
  const isFresh =
    !freshness ||
    Date.now() - freshness.lastUpdated.getTime() <= freshness.expectedRefresh;
  const ageMinutes = freshness
    ? Math.floor((Date.now() - freshness.lastUpdated.getTime()) / 60000)
    : null;
      ...
      {total === 0 ? (
        ...
        <>
          ...
          <div
            ...
            style={{ marginTop: "var(--space-2)", fontSize: "var(--t-2xs)" }}
          >

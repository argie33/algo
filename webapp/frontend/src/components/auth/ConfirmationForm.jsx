    ...
    <form onSubmit={handleSubmit} noValidate>
      <div style={{ textAlign: "center", marginBottom: "var(--space-5)" }}>
        <div style={{
          ...
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--brand-2)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="field-group" style={{ marginBottom: "var(--space-5)" }}>
        <label className="field-label" htmlFor="confirmationCode">Verification Code</label>
        <input
          className="input"
          id="confirmationCode"
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: "var(--space-4)", borderTop: "1px solid var(--border)" }}>
        <span style={{ fontSize: "var(--t-sm)", color: "var(--text-muted)" }}>
          ...
          <button
            ...
            style={{ background: "none", border: "none", padding: 0, cursor: resendCooldown > 0 ? "default" : "pointer", fontSize: "var(--t-sm)", color: resendCooldown > 0 ? "var(--text-faint)" : "var(--brand-2)", fontWeight: "var(--w-semibold)" }}
          >

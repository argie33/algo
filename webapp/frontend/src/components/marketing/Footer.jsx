      ...
      <Container maxWidth="xl">
        <Grid container spacing={5} sx={{ mb: 5 }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            >
              Institutional-grade equity research&mdash;systematic signals,
              multi-factor scoring, and market intelligence&mdash;completely
              free.
            </Typography>
            <Box
              sx={{
        ...
        >
          Bullseye Financial provides equity research and market analysis for
          ...
          results. All data is updated daily before market open.
        </Typography>
      </Container>
    </Box>
  );

...
vi.mock('recharts', () => ({
  ...
  ScatterChart: ({ children, data, ...props }) => (
    <div data-testid="scatter-chart" data-chart-data={JSON.stringify(data)} {...props}>
      {children}
    </div>
  ),
  ...
  Radar: ({ dataKey, stroke, ...props }) => (
    <div data-testid="radar" data-key={dataKey} data-stroke={stroke} {...props} />
  ),
  ...
  PolarRadiusAxis: ({ domain, ...props }) => (
    <div data-testid="polar-radius-axis" data-domain={JSON.stringify(domain)} {...props} />
  )
}));
...
vi.mock('react-chartjs-2', () => ({
  Line: ({ data, options: _options, ...props }) => (
    <div data-testid="chartjs-line" data-chart-data={JSON.stringify(data)} {...props}>
      Chart.js Line Chart
    </div>
  ),
  Doughnut: ({ data, options: _options, ...props }) => (
    <div data-testid="chartjs-doughnut" data-chart-data={JSON.stringify(data)} {...props}>
      Chart.js Doughnut Chart
    </div>
  ),
  Bar: ({ data, options: _options, ...props }) => (
    <div data-testid="chartjs-bar" data-chart-data={JSON.stringify(data)} {...props}>
      Chart.js Bar Chart
    </div>
  ),
  Pie: ({ data, options: _options, ...props }) => (
    <div data-testid="chartjs-pie" data-chart-data={JSON.stringify(data)} {...props}>
      Chart.js Pie Chart
    </div>
  )
}));

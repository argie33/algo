...
test.describe("Financial Platform - Visual Regression", () => {
  ...
  test("should capture screenshots of core pages (batch 1)", async ({
    page,
  }) => {
  ...
  test("should capture screenshots of core pages (batch 2)", async ({
    page,
  }) => {
  ...
  test("should capture screenshots of core pages (batch 3)", async ({
    page,
  }) => {
  ...
  test("should test mobile responsive design", async ({ page }) => {
    const mobileViewports = [{ width: 375, height: 667, name: "Mobile" }];
  ...
  test("should test dark mode vs light mode", async ({ page }) => {
    ...
    if (!darkModeToggled) {
      // Dark mode toggle not found on this page - theme toggle may be in different location
    }
        ...
        if (count > 0) {
          ...
          if (
            ...
            await page.screenshot({
              ...
              clip: (await firstElement.boundingBox()) || {
                x: 0,
                y: 0,
                width: 200,
                height: 50,

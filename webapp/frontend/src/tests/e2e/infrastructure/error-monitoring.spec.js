...
const IGNORE_PATTERNS = [
  ...
  /WebSocket connection.*failed.*ERR_CONNECTION_REFUSED/, // WebSocket connection failures (expected in test env)
  /RealTimeDataService.*WebSocket error/, // Real-time data service WebSocket errors (expected in test env)
  /RealTimeDataService.*Auto-connect failed/, // Real-time data auto-connect failures (expected in test env)
  /RealTimeDataService.*Reconnect failed/, // Real-time data reconnect failures (expected in test env)
  /API CONFIG.*Using fallback API URL/, // API configuration fallback (expected in test env)
  /Cognito not configured.*using dummy values/, // Cognito configuration warnings (expected in test env)
];

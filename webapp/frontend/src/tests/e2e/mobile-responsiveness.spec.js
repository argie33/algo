...
test.describe("Mobile Responsiveness - iPhone 12", () => {
  ...
  test("Dashboard should be readable and functional on mobile", async ({
    page,
  }) => {
    await page.goto("/");
  ...
  test("Stock Detail page should not have horizontal scroll", async ({
    page,
  }) => {
  ...
  test("Stock Explorer table should not cause horizontal scroll", async ({
    page,
  }) => {
...
test.describe("Tablet Responsiveness - iPad", () => {
  ...
  test("Dashboard should utilize tablet space effectively", async ({
    page,
  }) => {
    await page.goto("/");
    await page.waitForLoadState("networkidle");
...
test.describe("Responsive Breakpoint Tests", () => {
  ...
  test("Should adapt layout at desktop breakpoint (1920px)", async ({
    page,
  }) => {

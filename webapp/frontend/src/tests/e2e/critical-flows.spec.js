...
test.describe('Financial Platform Critical Workflows', () => {
  ...
  test('should navigate to key financial sections', async ({ page, browserName }) => {
      ...
      route.fulfill({
        json: {
          ...
          data: {
            ...
            dailyChange: 2500.25,
            holdings: [
              { symbol: 'AAPL', shares: 100, value: 18945.50, change: 245.25 },
              { symbol: 'GOOGL', shares: 25, value: 3512.75, change: -125.50 },
              { symbol: 'MSFT', shares: 150, value: 52525.00, change: 875.25 }
            ],
            sectors: [
    ...
    await page.route('**/api/market/**', route => {
      route.fulfill({
        json: {
          ...
          data: {
            indices: [
              { symbol: '^GSPC', name: 'S&P 500', value: 4520.25, change: 1.2, changePercent: 0.027 },
              { symbol: '^DJI', name: 'Dow Jones', value: 35180.50, change: 248.32, changePercent: 0.71 },
              { symbol: '^IXIC', name: 'NASDAQ', value: 14520.80, change: -45.25, changePercent: -0.31 }
            ],
            sectors: [

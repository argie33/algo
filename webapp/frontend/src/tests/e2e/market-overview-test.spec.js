...
test('Test Market Overview page specifically for MUI Tabs error', async ({ page }) => {
  ...
  console.log('🧪 Testing Market Overview page specifically...');
  
  // Navigate directly to market overview page
  ...
  if (muiTabsErrors.length > 0) {
    ...
    console.log(`✅ No MUI Tabs errors on Market Overview page`);
  }

  if (consoleErrors.length > 0) {
    console.log(`📝 All console errors:`);
    consoleErrors.slice(0, 5).forEach(error => console.log(`   - ${error.slice(0, 100)}...`));
  }

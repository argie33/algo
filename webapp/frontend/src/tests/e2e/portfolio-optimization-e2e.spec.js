...
test.describe("Portfolio Optimization Page", () => {
  ...
  test("should load portfolio optimization page with real data", async ({
    page,
  }) => {
    // Check page title
  ...
  test("should allow user to apply recommendations", async ({ page }) => {
    ...
    const applyButton = page.locator(
      'button:has-text("Apply All Recommendations")'
    );
  ...
  test("should display no fake data - verify all values are real", async ({
    page,
  }) => {

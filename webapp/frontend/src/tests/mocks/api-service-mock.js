...
export const createMockMarketData = () => ({
  indices: [
    { symbol: "SPY", price: 425.5, change: 2.25, changePercent: 0.53 },
    { symbol: "QQQ", price: 365.75, change: -1.5, changePercent: -0.41 },
    { symbol: "IWM", price: 185.25, change: 0.75, changePercent: 0.41 },
  ],
  topGainers: [
    { symbol: "AAPL", price: 150.25, changePercent: 3.25 },
    { symbol: "TSLA", price: 245.8, changePercent: 2.85 },
  ],
  topLosers: [
    { symbol: "AMZN", price: 125.3, changePercent: -2.15 },
...
export const createApiServiceMock = () => ({
  ...
  // Portfolio data
  getPortfolio: vi.fn(() => Promise.resolve(createMockPortfolioData())),
  ...
  getTopStocks: vi.fn(() =>
    Promise.resolve({
      data: [
        ...
        { symbol: "MSFT", price: 280.5, change: -1.25, changePercent: -0.44 },
        { symbol: "GOOGL", price: 2750.8, change: 15.3, changePercent: 0.56 },
      ],
    })
  ),
  ...
  getWatchlist: vi.fn(() =>
    Promise.resolve({
      data: [
        ...
        { symbol: "MSFT", price: 280.5, change: -1.25 },
      ],
    })
  ),
  ...
  getTechnicalData: vi.fn((symbol = "AAPL") =>
    Promise.resolve({
      ...
      data: {
        ...
        support: [145.5, 142.8, 138.9],
        resistance: [155.2, 160.75, 168.5],
        trend: "bullish",
        strength: "strong",
        signals: [
  ...
  get: vi.fn((url) => {
    ...
    if (url.includes("/portfolio"))
      return Promise.resolve(createMockPortfolioData());
    if (url.includes("/market"))
      return Promise.resolve({ data: createMockMarketData() });

...
describe("Real Site Functionality Tests", () => {
  ...
  describe("Core Pages Rendering", () => {
    ...
    it("should render Portfolio page with proper structure", async () => {
      ...
      await waitFor(
        () => {
          ...
          const portfolioElements = screen.queryAllByText(
            /portfolio|holdings|performance/i
          );
      ...
      await waitFor(
        () => {
          const marketElements = screen.queryAllByText(
            /market|overview|indices|sectors/i
          );
    ...
    it("should render Trading Signals page", async () => {
      ...
      await waitFor(
        () => {
          const signalElements = screen.queryAllByText(
            /trading|signals|buy|sell/i
          );
    ...
    it("should render Sentiment Analysis page", async () => {
      ...
      await waitFor(
        () => {
          const sentimentElements = screen.queryAllByText(
            /sentiment|analysis|news|social/i
          );
    ...
    it("should render Watchlist page", async () => {
      ...
      await waitFor(
        () => {
          const watchlistElements = screen.queryAllByText(
            /watchlist|symbols|stocks/i
          );
    ...
    it("should render stock detail with symbol parameter", async () => {
      ...
      await waitFor(
        () => {
          ...
          const stockElements = screen.queryAllByText(
            /stock|price|chart|analysis/i
          );

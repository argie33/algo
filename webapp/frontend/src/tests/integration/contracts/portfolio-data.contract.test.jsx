...
describe("Portfolio Data Contract Tests", () => {
  ...
  it("should validate portfolio holdings endpoint contract", async () => {
    if (skipIfServerUnavailable(serverAvailable, "portfolio holdings test"))
      return;
  ...
  it("should validate portfolio analytics endpoint contract", async () => {
    if (!serverAvailable) {
      console.warn(
        "Skipping portfolio analytics contract test - backend not available"
      );
      return;
    }
  ...
  it("should validate market overview endpoint contract", async () => {
    if (!serverAvailable) {
      console.warn(
        "Skipping market overview contract test - backend not available"
      );
      return;
    }

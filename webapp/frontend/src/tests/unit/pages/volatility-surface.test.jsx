/**
 * VolatilitySurface Page Unit Tests
 * Tests the /options/volatility route and its features
 */
...
describe('VolatilitySurface Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders volatilitysurface page without crashing', async () => {
    render(
      <TestWrapper>
        <VolatilitySurface />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/volatilitysurface|loading|dashboard|error/i);

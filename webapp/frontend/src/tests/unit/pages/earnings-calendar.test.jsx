 ...
 * Tests the /earnings route and its features
 */
...
describe('EarningsCalendar Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders earningscalendar page without crashing', async () => {
    render(
      <TestWrapper>
        <EarningsCalendar />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/earningscalendar|loading|dashboard|error/i);

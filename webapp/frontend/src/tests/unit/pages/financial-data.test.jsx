 ...
 * Tests the /financial-data route and its features
 */
...
describe('FinancialData Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders financialdata page without crashing', async () => {
    render(
      <TestWrapper>
        <FinancialData />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/financialdata|loading|dashboard|error/i);

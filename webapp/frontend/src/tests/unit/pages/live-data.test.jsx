/**
 * LiveData Page Unit Tests
 * Tests the /live-data route and its features
 */
...
describe('LiveData Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders livedata page without crashing', async () => {
    render(
      <TestWrapper>
        <LiveData />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/livedata|loading|dashboard|error/i);

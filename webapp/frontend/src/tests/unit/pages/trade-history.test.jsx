 ...
 * Tests the /portfolio/trade-history route and its features
 */
...
describe('TradeHistory Page', () => {
  ...
  it('renders tradehistory page without crashing', async () => {
    render(
      <TestWrapper>
        <TradeHistory />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/tradehistory|loading|dashboard|error/i);

/**
 * OptionsAnalytics Page Unit Tests
 * Tests the /options route and its features
 */
...
describe('OptionsAnalytics Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders optionsanalytics page without crashing', async () => {
    render(
      <TestWrapper>
        <OptionsAnalytics />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/optionsanalytics|loading|dashboard|error/i);

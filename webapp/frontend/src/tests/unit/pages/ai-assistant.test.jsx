 ...
 * Tests the /tools/ai route and its features
 */
...
describe('AIAssistant Page', () => {
  ...
  it('renders aiassistant page without crashing', async () => {
    render(
      <TestWrapper>
        <AIAssistant />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/aiassistant|loading|dashboard|error/i);

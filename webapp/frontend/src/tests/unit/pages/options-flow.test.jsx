/**
 * OptionsFlow Page Unit Tests
 * Tests the /options/flow route and its features
 */
...
describe('OptionsFlow Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders optionsflow page without crashing', async () => {
    render(
      <TestWrapper>
        <OptionsFlow />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/optionsflow|loading|dashboard|error/i);

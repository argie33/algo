/**
 * Commodities Page Unit Tests
 * Tests the /commodities route and its features
 */
...
describe('Commodities Page', () => {
  ...
  it('renders commodities page without crashing', async () => {
    render(
      <TestWrapper>
        <Commodities />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/commodities|loading|dashboard|error/i);

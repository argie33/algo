/**
 * OptionsStrategies Page Unit Tests
 * Tests the /options/strategies route and its features
 */
...
describe('OptionsStrategies Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders optionsstrategies page without crashing', async () => {
    render(
      <TestWrapper>
        <OptionsStrategies />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/optionsstrategies|loading|dashboard|error/i);

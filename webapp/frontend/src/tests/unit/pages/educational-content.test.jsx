/**
 * EducationalContent Page Unit Tests
 * Tests the /research/education route and its features
 */
...
describe('EducationalContent Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders educationalcontent page without crashing', async () => {
    render(
      <TestWrapper>
        <EducationalContent />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/educationalcontent|loading|dashboard|error/i);

 ...
 * Tests the /portfolio/optimize route and its features
 */
...
describe('PortfolioOptimization Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders portfoliooptimization page without crashing', async () => {
    render(
      <TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/portfoliooptimization|loading|dashboard|error/i);

 ...
 * Tests the /watchlist route and its features
 */
...
describe('Watchlist Page', () => {
  ...
  it('renders watchlist page without crashing', async () => {
    render(
      <TestWrapper>
        <Watchlist />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/watchlist|loading|dashboard|error/i);

...
describe("ComingSoon Component", () => {
  ...
  it("renders with custom page name", () => {
    ...
    expect(screen.getByText("Portfolio Analytics Coming Soon")).toBeInTheDocument();
  });

  it("renders with custom description", () => {
    const customDescription = "Advanced charting features are being implemented.";
  ...
  it("displays construction icon", () => {
    ...
    expect(container.querySelector('[data-testid="ConstructionIcon"]')).toBeInTheDocument();
  });

  it("displays encouraging message", () => {
    renderComingSoon();
    
    expect(screen.getByText(/we're working hard to bring you this feature/i)).toBeInTheDocument();
  ...
  it("handles long descriptions properly", () => {
    const longDescription = "This is a very long description that explains in great detail what this feature will do when it is completed and ready for users to enjoy.";

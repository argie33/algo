/**
 * AdvancedScreener Page Unit Tests
 * Tests the /screener-advanced route and its features
 */
...
describe('AdvancedScreener Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders advancedscreener page without crashing', async () => {
    render(
      <TestWrapper>
        <AdvancedScreener />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/advancedscreener|loading|dashboard|error/i);

/**
 * AnalystInsights Page Unit Tests
 * Tests the /analysts route and its features
 */
...
describe('AnalystInsights Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders analystinsights page without crashing', async () => {
    render(
      <TestWrapper>
        <AnalystInsights />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/analystinsights|loading|dashboard|error/i);

 ...
 * Tests the /economic route and its features
 */
...
describe('EconomicModeling Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders economicmodeling page without crashing', async () => {
    render(
      <TestWrapper>
        <EconomicModeling />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/economicmodeling|loading|dashboard|error/i);

/**
 * NewsSentiment Page Unit Tests
 * Tests the /sentiment/news route and its features
 */
...
describe('NewsSentiment Page', () => {
  ...
  it('renders newssentiment page without crashing', async () => {
    render(
      <TestWrapper>
        <NewsSentiment />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/newssentiment|loading|dashboard|error/i);

...
vi.mock("../../../components/EnhancedAIChat.jsx", () => ({
  default: vi.fn(() => <div data-testid="enhanced-ai-chat">AI Chat Component</div>),
}));
...
describe("AIAssistant Component", () => {
  ...
  it("renders AI assistant page", () => {
    ...
    expect(screen.getByText(/your personal ai-powered investment assistant/i)).toBeInTheDocument();
  });
  ...
  it("displays help text with capabilities", () => {
    ...
    expect(screen.getByText(/personalized investment guidance/i)).toBeInTheDocument();
  });

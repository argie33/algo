/**
 * GreeksMonitor Page Unit Tests
 * Tests the /options/greeks route and its features
 */
...
describe('GreeksMonitor Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders greeksmonitor page without crashing', async () => {
    render(
      <TestWrapper>
        <GreeksMonitor />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/greeksmonitor|loading|dashboard|error/i);

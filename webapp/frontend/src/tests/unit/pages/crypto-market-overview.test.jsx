/**
 * CryptoMarketOverview Page Unit Tests
 * Tests the /crypto route and its features
 */
...
describe('CryptoMarketOverview Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders cryptomarketoverview page without crashing', async () => {
    render(
      <TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/cryptomarketoverview|loading|dashboard|error/i);

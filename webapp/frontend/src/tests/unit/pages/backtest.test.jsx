/**
 * Backtest Page Unit Tests
 * Tests the /backtest route and its features
 */
...
describe('Backtest Page', () => {
  ...
  it('renders backtest page without crashing', async () => {
    render(
      <TestWrapper>
        <Backtest />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/backtest|loading|dashboard|error/i);

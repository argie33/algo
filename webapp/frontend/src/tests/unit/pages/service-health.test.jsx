 ...
 * Tests the /service-health route and its features
 */
...
describe('ServiceHealth Page', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders servicehealth page without crashing', async () => {
    render(
      <TestWrapper>
        <ServiceHealth />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/servicehealth|loading|dashboard|error/i);

 ...
 * Tests the /stocks/:ticker route and its features
 */
...
describe('StockDetail Page', () => {
  ...
  it('renders stockdetail page without crashing', async () => {
    render(
      <TestWrapper>
        <StockDetail />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/stockdetail|loading|dashboard|error/i);

 ...
 * Tests the /sectors route and its features
 */
...
describe('SectorAnalysis Page', () => {
  ...
  it('renders sectoranalysis page without crashing', async () => {
    render(
      <TestWrapper>
        <SectorAnalysis />
      </TestWrapper>
    ...
    await waitFor(() => {
      ...
      const pageContent = screen.getByText(/sectoranalysis|loading|dashboard|error/i);

...
describe("Trading Signals Page Component", () => {
  ...
  describe("Signal Details and Information", () => {
    it("should display key signal information", async () => {
      ...
      expect(
        screen.getByText(/450\.75/i) || screen.getByText(/\$450/i)
      ).toBeTruthy();

      // Should show target price
      expect(
        screen.getByText(/520\.00/i) || screen.getByText(/\$520/i)
      ).toBeTruthy();
  ...
  describe("Market Context and Summary", () => {
    it("should display market-wide signal summary", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/42/i) || screen.getByText(/total/i)
        ).toBeTruthy();
      });
      ...
      expect(
        screen.getByText(/bullish/i) || screen.getByText(/sentiment/i)
      ).toBeTruthy();
    });
    ...
    it("should indicate market conditions affecting signals", async () => {
      ...
      const conditionElements =
        screen.queryAllByText(/volatility/i) ||

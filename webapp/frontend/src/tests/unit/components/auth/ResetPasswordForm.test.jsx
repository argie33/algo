...
describe('ResetPasswordForm', () => {
  ...
  test('submits password reset', async () => {
    ...
    await waitFor(() => {
      expect(mockForgotPasswordSubmit).toHaveBeenCalledWith('testuser', '123456', 'NewPassword123!');
    });
  });
  ...
  test('calls onPasswordResetSuccess on success', async () => {
    ...
    render(<ResetPasswordForm {...defaultProps} onPasswordResetSuccess={onPasswordResetSuccess} />);
  ...
  test('switches back to login', () => {
    ...
    render(<ResetPasswordForm {...defaultProps} onSwitchToLogin={onSwitchToLogin} />);

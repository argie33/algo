...
describe('ApiKeyManager Component', () => {
  ...
  describe('API Key Display', () => {
    it('should display existing API keys with masked information', () => {
      ...
      expect(screen.getByText(/interactive.brokers|interactive_brokers/i)).toBeInTheDocument();
    ...
    it('should show API key status indicators', () => {
      ...
      expect(screen.getByText(/inactive/i) || screen.queryByText(/disabled/i)).toBeTruthy();
    });
    ...
    it('should show last used timestamps', () => {
      ...
      expect(screen.getByText(/last used/i) || screen.getByText(/2024-01-15/)).toBeTruthy();
    });
    ...
    it('should display empty state when no API keys exist', () => {
      ...
      expect(screen.getByText(/no api keys|add your first|get started/i)).toBeInTheDocument();
    });
  });
  ...
  describe('Adding API Keys', () => {
    ...
    it('should render add API key form with required fields', async () => {
      ...
      expect(screen.getByLabelText(/provider/i) || screen.getByText(/provider/i)).toBeInTheDocument();
      expect(screen.getByLabelText(/api key/i) || screen.getByPlaceholderText(/api key/i)).toBeInTheDocument();
      expect(screen.getByLabelText(/secret|private/i) || screen.getByPlaceholderText(/secret|private/i)).toBeInTheDocument();
      expect(screen.getByLabelText(/environment/i) || screen.getByText(/sandbox|live/i)).toBeInTheDocument();
    });
    ...
    it('should validate required fields before submission', async () => {
      ...
      expect(screen.getByText(/required|please fill|invalid/i) || screen.getAllByText(/required|please fill|invalid/i).length > 0).toBeTruthy();
    ...
    it('should submit valid API key data', async () => {
      ...
      const secretInput = screen.getByLabelText(/secret|private/i) || screen.getByPlaceholderText(/secret|private/i);
      ...
      const providerSelect = screen.queryByRole('combobox') || screen.queryByLabelText(/provider/i);
      if (providerSelect) {
  ...
  describe('Security Features', () => {
    it('should never display full API keys or secrets', () => {
      ...
      expect(screen.queryByText(/secret-key|private-key/)).not.toBeInTheDocument();
    });
    ...
    it('should have environment selection for sandbox vs live', async () => {
      ...
      expect(screen.getByText(/sandbox/i) || screen.getByText(/test/i)).toBeInTheDocument();
      expect(screen.getByText(/live/i) || screen.getByText(/production/i)).toBeInTheDocument();
    });
  });

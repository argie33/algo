...
describe("Card Components", () => {
  describe("Card", () => {
    ...
    test("forwards additional props", () => {
      render(
        <Card data-testid="test-card" elevation={3}>
          Test
        </Card>
      );
  ...
  describe("CardDescription", () => {
    ...
    test("applies custom className", () => {
      render(
        <CardDescription className="custom-desc">Test Desc</CardDescription>
      );
  ...
  describe("Complete Card Structure", () => {
    ...
    test("handles nested card structure with proper hierarchy", () => {
      ...
      const outerCard = screen
        .getByText("Inner card content")
        .closest(".outer-card");
      const innerCard = screen
        .getByText("Inner card content")
        .closest(".inner-card");

...
describe('RealTimePriceWidget', () => {
  ...
  describe('Rendering', () => {
    ...
    test('displays loading skeleton initially', () => {
      ...
      expect(screen.getByTestId('loading-skeleton') || screen.getByRole('progressbar')).toBeInTheDocument();
    });
    ...
    test('shows trending up icon for positive change', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId('TrendingUpIcon') || screen.getByLabelText(/trending up/i)).toBeInTheDocument();
      });
    });
    ...
    test('shows trending down icon for negative change', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId('TrendingDownIcon') || screen.getByLabelText(/trending down/i)).toBeInTheDocument();
      });
    });
    ...
    test('shows flat icon for zero change', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId('TrendingFlatIcon') || screen.getByLabelText(/no change/i)).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Error Handling', () => {
    test('displays error message when fetch fails', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/Unable to load price data/i) || 
  ...
  describe('Data Staleness', () => {
    test('indicates stale data', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/stale/i) || screen.getByText(/delayed/i)).toBeInTheDocument();
      });
    });
  ...
  describe('Edge Cases', () => {
    ...
    test('handles missing symbol prop', () => {
      ...
      expect(screen.getByRole('progressbar') || screen.getByText(/error/i)).toBeInTheDocument();
    });

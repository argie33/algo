...
describe("NewsAnalyzer", () => {
  ...
  describe("sentiment analysis", () => {
    it("detects positive sentiment", () => {
      const positiveText =
        "Strong growth and profits surge, stock rallies on breakthrough earnings beat";
    ...
    it("detects negative sentiment", () => {
      const negativeText =
        "Stock crashes, massive losses, company misses expectations badly";
    ...
    it("detects neutral sentiment", () => {
      const neutralText =
        "Company reports quarterly results, maintains guidance for next quarter";
  ...
  describe("keyword extraction", () => {
    it("extracts relevant financial keywords", () => {
      const text =
        "Apple reports strong earnings, revenue up 15%, profit margins expanding";
  ...
  describe("impact scoring", () => {
    it("assigns higher impact to major financial events", () => {
      const majorEvent =
        "Apple announces stock split, revenue beats expectations by 20%";
    ...
    it("considers text length in impact calculation", () => {
      const longText =
        "Detailed analysis of quarterly performance shows significant growth across all business segments with strong margin expansion and positive outlook for the remainder of the fiscal year";
  ...
  describe("symbol extraction", () => {
    it("extracts stock symbols from text", () => {
      const text =
        "AAPL and MSFT both reported strong earnings, while TSLA missed expectations";
  ...
  describe("article categorization", () => {
    it("categorizes earnings-related articles", () => {
      const text =
        "Quarterly earnings report shows revenue growth and profit margin expansion";
    ...
    it("categorizes market analysis articles", () => {
      const text =
        "Technical analysis indicates potential breakout pattern in major indices";
      const category = analyzer.categorizeArticle(text);

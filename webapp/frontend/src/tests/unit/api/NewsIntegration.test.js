    ...
    news: [
      {
        ...
        content_summary:
          "Strong earnings performance with revenue growth across all segments",
      ...
      },
      {
        ...
        summary:
          "Tesla shares declined following reports of potential production delays at its new facility.",
        ...
        content_summary:
          "Production challenges may impact quarterly delivery targets",
...
describe("News Integration API", () => {
  ...
  describe("News Retrieval", () => {
    it("fetches news successfully", async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(expect.stringContaining("/api/news?"));
  ...
  describe("Error Handling", () => {
    ...
    it("handles sentiment analysis errors", async () => {
      ...
      await expect(newsAPI.getSentimentAnalysis()).rejects.toThrow(
        "Sentiment analysis failed: 503"
      );
    });
  ...
  describe("Performance and Quality", () => {
    ...
    it("handles large datasets efficiently", async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(expect.stringContaining("limit=100"));
    });

...
describe('PortfolioPerformance Component', () => {
  const mockPerformanceData = {
    ...
    performance: {
      ...
      data: [
        ...
        { date: '2023-06-01', value: 110000, returns: 10.00 },
        { date: '2023-12-01', value: 125000, returns: 25.00 }
      ]
    },
    analytics: {
      sharpeRatio: 1.45,
  ...
  describe('Component Loading', () => {
    ...
    it('should show loading state initially', async () => {
      ...
      expect(screen.getByText(/Loading portfolio performance/i)).toBeInTheDocument();

      await waitFor(() => {
        expect(screen.queryByText(/Loading portfolio performance/i)).not.toBeInTheDocument();
      }, { timeout: 200 });
    });
  });
  ...
  describe('Performance Chart', () => {
    ...
    it('should switch between different time ranges', async () => {
      ...
      await waitFor(() => {
        expect(api.get).toHaveBeenCalledWith('/api/portfolio/performance?timeRange=6M');
      });
    });
  ...
  describe('Time Range Filters', () => {
    ...
    it('should update data when time range changes', async () => {
      ...
      await waitFor(() => {
        expect(api.get).toHaveBeenLastCalledWith('/api/portfolio/performance?timeRange=3M');
      });
    });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle network errors', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/Unable to load portfolio performance/i)).toBeInTheDocument();
      });
    });
  ...
  describe('Accessibility', () => {
    it('should have proper ARIA labels', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByLabelText(/Portfolio total value/i)).toBeInTheDocument();
        expect(screen.getByLabelText(/Portfolio gain loss/i)).toBeInTheDocument();
      });
    });
    ...
    it('should announce data updates to screen readers', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByLabelText(/Portfolio performance updated/i)).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Performance Optimization', () => {
    ...
    it('should debounce rapid filter changes', async () => {
      ...
      await waitFor(() => {
        expect(api.get).toHaveBeenLastCalledWith('/api/portfolio/performance?timeRange=1M');
      });

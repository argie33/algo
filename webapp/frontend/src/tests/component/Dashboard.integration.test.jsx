...
describe('Dashboard Integration Tests', () => {
  const mockDashboardData = {
    ...
    performance: {
      ...
      data: [
        ...
        { date: '2023-06-05', value: 123000, returns: 2.50 },
  ...
  describe('News Section Integration', () => {
    it('should display recent news articles', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Market Reaches New High Amid Tech Rally')).toBeInTheDocument();
        expect(screen.getByText('Fed Minutes Show Cautious Approach to Interest Rates')).toBeInTheDocument();
    ...
    it('should show news sentiment indicators', async () => {
      ...
      await waitFor(() => {
        ...
        const newsSection = screen.getByText('Recent News').closest('[data-testid="news-section"]') || 
  ...
  describe('Alerts Section Integration', () => {
    it('should display active alerts', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/AAPL reached your price target/i)).toBeInTheDocument();
        expect(screen.getByText(/Unusual volume detected in MSFT/i)).toBeInTheDocument();
      });
    });
    ...
    it('should show alert severity levels', async () => {
      ...
      await waitFor(() => {
        ...
        const alertsSection = screen.getByText(/Alerts/i).closest('section') || 
  ...
  describe('Accessibility', () => {
    it('should have proper ARIA labels for all sections', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByLabelText(/portfolio overview/i)).toBeInTheDocument();
    ...
    it('should support high contrast mode', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId('high-contrast-dashboard')).toBeInTheDocument();
      });
    });
  });
});
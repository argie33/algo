...
export const CHART_GRADIENTS = {
  ...
  primary: {
    ...
    stops: [
      ...
      {
        offset: "100%",
        color: FINANCIAL_COLORS.primary.primary,
        opacity: 0.02,
      },
    ],
  },
  secondary: {
    ...
    stops: [
      ...
      {
        offset: "100%",
        color: FINANCIAL_COLORS.secondary.primary,
        opacity: 0.01,
      },
    ],
  },
...
export const getValueColor = (value, options = {}) => {
  const {
    bullishColor = FINANCIAL_COLORS.bullish.primary,
    bearishColor = FINANCIAL_COLORS.bearish.primary,
    neutralColor = FINANCIAL_COLORS.neutral.primary,
  } = options;

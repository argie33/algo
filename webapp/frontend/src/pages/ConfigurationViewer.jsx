...
export default function ConfigurationViewer() {
  ...
  const categories = CATEGORY_ORDER.filter(
    (cat) => (groupedConfig[cat] || []).length > 0
  );
      ...
      <div className="page-head">
        <div>
          ...
          <div className="page-head-sub">
            View all trading parameters and thresholds
          </div>
        </div>
      </div>
            ...
            {categories.map((cat) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: "4px",
                  color:
                    selectedCategory === cat ? "var(--brand)" : "var(--text)",
                  fontSize: "13px",
                  cursor: "pointer",
                  textAlign: "left",
                  transition: "all 0.2s",
...
function ConfigItem({ item, onUpdate }) {
  ...
  const valueEqualsDefault =
    String(currentVal || "").trim() === String(defaultVal || "").trim();
      ...
      >
        <div>
          ...
          {item.value_type && (
            ...
            >
              Type:{" "}
              <code style={{ fontFamily: "monospace" }}>{item.value_type}</code>
            </div>
          )}
        </div>
        ...
        {defaultVal !== undefined && defaultVal !== null && (
          <div>
            ...
            >
              Default Value{" "}
              {!valueEqualsDefault && (
                <span style={{ color: "var(--amber)" }}>• Different</span>
              )}
            </div>
            <div
              style={{
                ...
                fontFamily: "monospace",
                padding: "6px 8px",
                background: !valueEqualsDefault
                  ? "var(--surface-3)"
                  : "var(--surface-2)",
                borderRadius: "3px",
                color: !valueEqualsDefault
                  ? "var(--amber)"
                  : "var(--text-muted)",
                wordBreak: "break-all",
                border: !valueEqualsDefault

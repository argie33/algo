    ...
    >
      <div style={{ flex: 1 }}>
        ...
        <div style={{ fontSize: "12px", color: "var(--text-secondary)" }}>
          Current: {typeof value === "number" ? formatNumber(value, 2) : value}
          {unit}
        </div>
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        ...
        {passed == null ? (
          <span
            ...
            title="Constraint check unavailable - no data returned"
          >
            N/A
          </span>
        ) : passed ? (
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            fontWeight: "bold",
            cursor:
              loading || !symbol || !positionValue ? "not-allowed" : "pointer",
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ fontWeight: "bold" }}>
                  {result.entry_price != null
                    ? `$${Number(result.entry_price).toFixed(2)}`
                    : "—"}
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontWeight: "bold" }}>
                  {result.position_dollars != null
                    ? `$${Number(result.position_dollars).toFixed(2)}`
                    : "—"}
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontWeight: "bold", color: "var(--amber)" }}>
                  {result.pct_of_portfolio != null
                    ? `${Number(result.pct_of_portfolio).toFixed(2)}%`
                    : "—"}
                </span>
              </div>
              <div
          ...
          >
            ...
            >
              ...
              {!result.sector_exposure ? (
                <AlertCircle
                  size={20}
                  color="var(--text-secondary)"
                  title="No sector exposure data returned"
                />
            ...
            <div
              style={{
                ...
                marginBottom: "12px",
                borderRadius: "4px",
                background: !result.sector_exposure
                  ? "var(--bg-primary)"
                  : result.sector_exposure.warning
                    ? "#7f1d1d"
                    : "#064e3b",
                color: !result.sector_exposure
                  ? "var(--text-secondary)"
                  : result.sector_exposure.warning
                    ? "#fca5a5"
                    : "#a7f3d0",
            ...
            >
              {!result.sector_exposure
                ...
                : result.sector_exposure.warning_msg ||
                  "Within sector concentration limits"}
            </div>

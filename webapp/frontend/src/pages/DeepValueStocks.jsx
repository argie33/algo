...
const DeepValueStocksContent = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useApiQuery(["deepValueStocks", limit], () =>
        ...
        >
          ...
          >
            ...
            >
              ...
              {(stock.quality_rank === "tier1" ||
                stock.quality_rank === "tier2") && (
                <VerifiedIcon
                  size={18}
                  color={tier.color}
                  style={{ flexShrink: 0 }}
          ...
          <div style={{ padding: "var(--space-5)", fontSize: "var(--t-sm)" }}>
            ...
            >
              ...
              <MetricGrid
                items={[
                  ...
                  [
                    "↓52w",
                    fmtPct(stock.drop_from_52w_high_pct),
                    stock.drop_from_52w_high_pct >= 30 ? "#ef4444" : "inherit",
                  ],
                  [
                    "↓3y",
                    fmtPct(stock.drop_from_3y_high_pct),
                    stock.drop_from_3y_high_pct >= 40 ? "#ef4444" : "inherit",
                  ],
            ...
            >
              ...
              {stock._financial_data_unavailable && (
                ...
                >
                  Financial data not yet available — quality metrics pending
                  loader run
                </p>
              )}
              <MetricGrid
                items={[
                  [
                    ...
                    stock.roe_pct >= 35 ? "#22c55e" : "inherit",
                  ],
            ...
            >
              ...
              <MetricGrid
                items={[
                  [
                    "Rev 3Y CAGR",
                    fmtPct(stock.revenue_growth_3y_pct),
                    stock.revenue_growth_3y_pct >= 10 ? "#22c55e" : "inherit",
                  ],
                  [
                    "EPS 3Y CAGR",
                    fmtPct(stock.eps_growth_3y_pct),
                    stock.eps_growth_3y_pct >= 15 ? "#22c55e" : "inherit",
                  ],
                  [
                    "Rev YoY",
                    fmtPct(stock.revenue_growth_yoy_pct),
                    stock.revenue_growth_yoy_pct >= 5
                      ? "#a1d922"
                      : stock.revenue_growth_yoy_pct < 0
                        ? "#ef4444"
                        : "inherit",
                  ],
                  [
                    "FCF YoY",
                    fmtPct(stock.fcf_growth_yoy_pct),
                    stock.fcf_growth_yoy_pct >= 0 ? "#a1d922" : "#ef4444",
                  ],
                  ["Sust Growth", fmtPct(stock.sustainable_growth_pct)],
                  [
                    "PEG",
                    fmt(stock.peg_ratio),
                    stock.peg_ratio < 1 && stock.peg_ratio > 0
                      ? "#22c55e"
                      : "inherit",
                  ],
                ]}
            ...
            >
              ...
              >
                Are quality metrics improving ✓ or declining ✗? Negative =
              ...
              <MetricGrid
                items={[
                  [
                    "Op M Trend",
                    stock.op_margin_trend_pp != null
                      ? `${stock.op_margin_trend_pp >= 0 ? "+" : ""}${stock.op_margin_trend_pp.toFixed(2)}pp`
                      : "—",
                  ...
                  [
                    "ROE Trend",
                    stock.roe_trend_pp != null
                      ? `${stock.roe_trend_pp >= 0 ? "+" : ""}${stock.roe_trend_pp.toFixed(2)}pp`
                      : "—",
                    stock.roe_trend_pp >= 0
                      ? "#22c55e"
                      : stock.roe_trend_pp > -10
                        ? "#f97316"
                        : "#ef4444",
                  ],
                ]}
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <li>
                <strong>Tier 1:</strong> ROE ≥ 25% + Op Margin ≥ 15%
              </li>
              <li>
                <strong>Tier 2:</strong> ROE ≥ 20% + Op Margin ≥ 12%
              </li>
            ...
            >
              Anomaly Detection (Valuation Mismatch)
            </h3>
            <p
              style={{ margin: "0 0 var(--space-2) 0", color: "var(--text-2)" }}
            >
              Compares valuation to three baselines:
            </p>
            <ul
              style={{
                margin: "0 0 var(--space-3) var(--space-3)",
            ...
            >
              <li>
                <strong>Historical:</strong> Current P/E vs 3y average. Shows
                temporary panic.
              </li>
              <li>
                <strong>Sector Peers:</strong> Current P/E vs sector median.
                Market misprice signal.
              </li>
              <li>
                <strong>Overall Market:</strong> Current P/E vs S&P 500 median.
            ...
            >
              ...
              >
                🎯 EXCEPTIONAL QUALITY meets ANOMALY PRICING. Rare — perhaps
                5-30 stocks at any moment. Where generational wealth compounds.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div style={{ padding: "var(--space-6)" }}>
      <div style={{ marginBottom: "var(--space-6)" }}>
        ...
        >
          Tier-1 quality companies trading at anomaly prices. These stocks
          combine exceptional fundamentals (ROE &gt; 25%, margins &gt; 15%) with
          extreme valuations discounts. This is where generational wealth is
          built.
        </p>
      </div>
      ...
      <div className="grid grid-4" style={{ marginBottom: "var(--space-6)" }}>
        ...
        <div className="kpi">
          ...
          <div className="kpi-value" style={{ color: "#ef4444" }}>
            {avgDrop != null ? avgDrop.toFixed(0) + "%" : "—"}
          </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <option value="discount_vs_sector_pe_pct">
                Sector PE Discount
              </option>
      ...
      {stocks.length === 0 ? (
        <div className="alert alert-info">
          No generational opportunities found at this time. Market conditions
          may need deeper dislocations.
        </div>
      ) : (
        <>
          <div
          ...
          >
            ...
            <div style={{ display: "flex", gap: "var(--space-2)" }}>
              ...
              <button
                className="btn btn-sm btn-outline"
                disabled={(page + 1) * rowsPerPage >= sorted.length}
                onClick={() => setPage((p) => p + 1)}
              >
                Next
              </button>
            ...
            <table className="data-table" style={{ marginBottom: 0 }}>
              <thead>
                <tr>
                  ...
                  <th
                    style={{ textAlign: "right", cursor: "pointer" }}
                    onClick={() => handleSort("trailing_pe")}
                  >
                    P/E
                  </th>
                  <th
                    style={{ textAlign: "right", cursor: "pointer" }}
                    onClick={() => handleSort("roe_pct")}
                  >
                    ROE%
                  </th>
                  <th
                    style={{ textAlign: "right", cursor: "pointer" }}
                    onClick={() => handleSort("op_margin_pct")}
                  >
                    OpM%
                  </th>
                  <th
                    style={{ textAlign: "right", cursor: "pointer" }}
                    onClick={() => handleSort("drop_from_52w_high_pct")}
                  >
                    ↓52w
                  </th>
                  <th
                    style={{ textAlign: "right", cursor: "pointer" }}
                    onClick={() => handleSort("drop_from_3y_high_pct")}
                  >
                    ↓3y
                  </th>
                  <th
                ...
                {paginated.map((stock, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ fontSize: "var(--t-sm)", fontWeight: 500 }}>
                        {stock.company_name || "—"}
                      </td>
                      <td
                        style={{
                      ...
                      <td
                        style={{ textAlign: "right", fontSize: "var(--t-2xs)" }}
                      >
                        {fmt(stock.trailing_pe)}
                      </td>
                      <td
                        style={{
                          textAlign: "right",
                          fontSize: "var(--t-2xs)",
                          color:
                            stock.roe_pct != null && stock.roe_pct > 25
                              ? "#22c55e"
                              : "inherit",
                          fontWeight: stock.roe_pct > 25 ? 700 : 400,
                        }}
                      >
                        {fmtPct(stock.roe_pct)}
                      </td>
                      <td
                        style={{
                          ...
                          fontSize: "var(--t-2xs)",
                          color:
                            stock.op_margin_pct != null &&
                            stock.op_margin_pct > 15
                              ? "#22c55e"
                              : "inherit",
                          fontWeight: stock.op_margin_pct > 15 ? 700 : 400,
                        }}
                      >
                        {fmtPct(stock.op_margin_pct)}
                      </td>
                      <td
                        style={{
                          ...
                          fontSize: "var(--t-2xs)",
                          color:
                            stock.drop_from_52w_high_pct >= 30
                              ? "#c62828"
                              : "inherit",
                          fontWeight:
                            stock.drop_from_52w_high_pct >= 25 ? 700 : 400,
                        }}
                      >
                      ...
                      <td
                        style={{
                          ...
                          fontSize: "var(--t-2xs)",
                          color:
                            stock.drop_from_3y_high_pct >= 50
                              ? "#c62828"
                              : "inherit",
                          fontWeight:
                            stock.drop_from_3y_high_pct >= 40 ? 700 : 400,
                        }}
                      >

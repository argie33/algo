...
const WealthManagement = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Risk-based position sizing calculates trade size as a percentage of portfolio capital, calibrated to volatility (ATR) and account-level risk parameters set in the system configuration.",
    },
  ];
  ...
  const riskLevels = [
    {
      ...
      detail: "Maximum portfolio drawdown threshold before trading halts",
    },
    {
      label: "Daily Loss Cap",
      detail: "Single-session P&L floor that triggers a circuit breaker",
    },
    {
      label: "Consecutive Losses",
      detail: "Streak-based risk filter to pause after losing runs",
    },
    {
      label: "VIX Gate",
      detail: "Market volatility threshold that restricts new entries",
    },
    {
      label: "ATR Sizing",
      detail: "Position size scaled to each stock's average true range",
    },
    {
      label: "Market Stage",
      detail: "No new longs in Stage 4 (declining) market regimes",
    },
  ];
    ...
    <MarketingLayout>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={7} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              >
                The best trade is the one that doesn&apos;t blow up your
                portfolio. Bullseye&apos;s risk management layer enforces
                position sizing, monitors drawdown, and runs automated circuit
                breakers&#8212;so discipline is built into the system, not left
                to willpower.
              </Typography>
              <Typography
                variant="body1"
              ...
              >
                From pre-trade simulation to real-time P&amp;L tracking and full
                performance analytics, the portfolio tools give you the
                visibility and controls that professional traders rely on.
              </Typography>
            </Grid>
            <Grid item xs={12} md={6}>
              <ImagePlaceholder
      ...
      >
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 5 }}>
            ...
            >
              Every trade passes through automated risk checks before execution.
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 10 } }}>
        <Box sx={{ textAlign: "center", mb: 7 }}>
          ...
          >
            Professional-grade portfolio management tools built for active
            traders and systematic investors
          </Typography>
        </Box>
        ...
        <Grid container spacing={3}>
          {features.map((feature, idx) => (
            <Grid item xs={12} sm={6} key={idx}>
              <Card
                onClick={
                  feature.link ? () => navigate(feature.link) : undefined
                }
                sx={{
                  height: "100%",
                  border: `1px solid ${theme.palette.divider}`,

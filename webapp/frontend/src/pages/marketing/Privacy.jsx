      ...
      <Container maxWidth="md" sx={{ py: { xs: 6, md: 8 } }}>
        <Box sx={{ lineHeight: 1.8 }}>
          ...
          <List sx={{ color: theme.palette.text.secondary, ml: 2 }}>
            <ListItem>
              • Email address when you sign up for our newsletter or services
            </ListItem>
            <ListItem>
              • Name and contact information when you submit a contact form
            </ListItem>
            <ListItem>
          ...
          <List sx={{ color: theme.palette.text.secondary, ml: 2 }}>
            <ListItem>
              • To send you newsletters and updates you've signed up for
            </ListItem>
            <ListItem>
          ...
          <Typography sx={{ color: theme.palette.text.secondary, mb: 3 }}>
            We may use third-party services (such as email providers, analytics
            services, and hosting providers) to process your information. These
            third parties are contractually obligated to use your information
            only as necessary to provide services to us and maintain
            confidentiality.
          </Typography>
          ...
          <Typography sx={{ color: theme.palette.text.secondary, mb: 3 }}>
            ...
            cookie settings through your browser preferences. Some cookies are
            essential for website functionality, while others help us understand
          ...
          <Typography sx={{ color: theme.palette.text.secondary, mb: 3 }}>
            When you subscribe to our newsletter, we will send you regular
            updates and information about our services. You can unsubscribe at
            any time by clicking the unsubscribe link in any email or by
          ...
          <Typography sx={{ color: theme.palette.text.secondary, mb: 3 }}>
            ...
            parental consent, we will delete such information immediately.
          </Typography>
          ...
          <Typography sx={{ color: theme.palette.text.secondary, mb: 3 }}>
            ...
            website and updating the "Last updated" date below.
          </Typography>

    ...
    <MarketingLayout>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={7} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              >
                Bullseye Financial was built by investors who were frustrated
                watching Wall Street have all the advantages. The systematic
                tools that drive institutional returns&#8212;quantitative
                screening, earnings analytics, market health monitoring, trend
                analysis&#8212;shouldn&apos;t require a six-figure budget.
              </Typography>
              <Typography
                sx={{
                  fontSize: "1.05rem",
              ...
              >
                So we built them. From the ground up. The entire
                platform&#8212;data pipeline, research models, trading
                algorithm, and web interface&#8212;was designed and built
                in-house. Every piece reflects years of research into what
      ...
      >
        <Container maxWidth="md">
          ...
          >
            We believe independent, evidence-based research drives better
            investment decisions. By removing conflicts of interest and keeping
            the platform free, we empower every investor&#8212;from active
            traders to long-term investors&#8212;to compete on the same footing
        ...
        <Container maxWidth="lg">
          <Grid container spacing={3}>
            {[
              {
                metric: "5,300+",
                label: "US Equities Covered",
                detail:
                  "Comprehensive coverage across all market caps and sectors",
              },
              {
                metric: "10+",
                label: "Years of Historical Data",
                detail: "Deep history for backtesting and pattern validation",
              },
              {
                metric: "6",
                label: "Research Dimensions",
                detail:
                  "Fundamental, technical, earnings, sentiment, sector, quant",
              },
              {
                metric: "24",
                label: "Automated Data Loaders",
                detail: "Running daily before market open, every trading day",
              },
            ].map((item, idx) => (

    ...
    <MarketingLayout>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={7} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              >
                Superior investment outcomes require superior research. Bullseye
                Financial delivers institutional-grade equity analysis combining
                rigorous fundamental analysis, quantitative modeling, and
                technical research into a comprehensive platform accessible to
      ...
      >
        <Container maxWidth="md">
          ...
          >
            &#8220;Independent research, transparent methodology, and the
            conviction to follow the data wherever it leads.&#8221;
          </Typography>
          <Typography
            sx={{
              textAlign: "center",
      ...
      >
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 7 }}>
            ...
            >
              Six principles that guide every research decision, every model we
              build, and every signal we publish
            </Typography>
          </Box>

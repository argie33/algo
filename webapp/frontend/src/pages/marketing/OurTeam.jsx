  ...
  const platformPillars = [
    {
      ...
      description: 'Automated daily pipeline loading 24 data sources&#8212;prices, technicals, fundamentals, earnings, sentiment, and economic indicators&#8212;into a centralized research database updated before market open.',
    },
    {
      icon: <CodeIcon />,
      title: 'Research Engine',
      description: 'Multi-factor scoring models combining Minervini trend analysis with fundamental quality filters, earnings dynamics, and market breadth indicators. Every signal is backtested and validated before deployment.',
    },
    {
      icon: <SpeedIcon />,
      title: 'Live Trading System',
      description: 'Seven-phase orchestration algorithm that runs at market open and close&#8212;checking data freshness, evaluating circuit breakers, managing positions, executing signals, and reconciling with the broker.',
    },
    {
      icon: <SecurityIcon />,
      title: 'Research Platform',
      description: 'Full-stack web application surfacing scores, signals, earnings, sector analysis, economic data, and portfolio tracking. Built for serious investors who want professional-grade research without the institutional price tag.',
    },
  ];
    ...
    <MarketingLayout>
      ...
      <Box sx={{ py: { xs: 8, md: 10 }, backgroundColor: theme.palette.background.default }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 7 }}>
            ...
            >
              We&apos;re not a hundred-person research firm. We&apos;re a small team who built the entire
              platform&#8212;data pipeline, trading algorithm, research models, and web application&#8212;from scratch.
              That focus is what makes the platform exceptional.
            </Typography>
          </Box>
              ...
              <Grid item xs={12} sm={10} md={6} key={member.name}>
                ...
                >
                  <CardContent sx={{ p: 4 }}>
                    ...
                    <Typography
                      variant="body2"
                      sx={{ mb: 3, color: theme.palette.text.secondary, lineHeight: 1.8, fontSize: '0.95rem' }}
      ...
      <Box sx={{ py: { xs: 8, md: 10 }, backgroundColor: theme.palette.background.paper }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 7 }}>
            ...
            >
              Every piece of the platform&#8212;from the AWS infrastructure and data loaders to the
              trading algorithm and research dashboard&#8212;was designed and built by us.
            </Typography>
          </Box>
      ...
      >
        <Container maxWidth="md">
          ...
          >
            &#8220;Independent research, no conflicts, no subscriptions.
            Just the best tools we could build.&#8221;
          </Typography>
          <Typography
            sx={{
              textAlign: 'center',

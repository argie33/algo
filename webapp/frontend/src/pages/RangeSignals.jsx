...
import RangeSignalAccordion from "../components/RangeSignalAccordion";
      ...
      <ErrorBoundary fallback={<ErrorDisplay />}>
        {isLoading ? (
          ...
          <>
            ...
            <RangeSignalAccordion signals={filteredSignals.slice(page * rowsPerPage, (page + 1) * rowsPerPage)} />
          </>
        )}
      </ErrorBoundary>
    </Container>

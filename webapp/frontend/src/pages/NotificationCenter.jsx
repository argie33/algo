  ...
  if (notifError) {
    return (
      <div className="alert alert-danger" style={{ margin: "20px" }}>
        {notifError?.message || "Failed to load notifications"}
      </div>
    );
  }
    ...
    <div style={{ padding: "20px", background: "var(--bg)" }}>
      ...
      {loading ? (
        ...
        >
          ...
          <p style={{ fontSize: "var(--t-lg)", fontWeight: "bold" }}>
            No notifications
          </p>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  ...
                  <span
                    className={`badge ${getKindBadgeColor(notif.kind)}`}
                    style={{
                      padding: "2px 8px",
                      fontSize: "var(--t-2xs)",
                      fontWeight: "bold",

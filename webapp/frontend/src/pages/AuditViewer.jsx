        ...
        {["trades", "config", "safeguards"].map((tab) => (
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              borderBottom:
                activeTab === tab ? "2px solid var(--accent-color)" : "none",
                    ...
                    >
                      <span
                        style={{
                          ...
                          fontSize: "12px",
                          fontWeight: "bold",
                          background: getActionTypeColor(item.action_type),
                          color: "white",
                        }}
                      >
      ...
      {items.length > 0 && (
        ...
        >
          <div style={{ color: "var(--text-secondary)", fontSize: "12px" }}>
            Showing {offset + 1}-
            {Math.min(offset + limit, auditData?.total || 0)} of{" "}
            {auditData?.total || 0}
          </div>
          <div style={{ display: "flex", gap: "8px" }}>
            <button
              ...
              style={{
                padding: "8px 12px",
                background:
                  offset === 0 ? "var(--bg-secondary)" : "var(--accent-color)",
            ...
            <button
              ...
              style={{
                padding: "8px 12px",
                background:
                  offset + limit >= (auditData?.total || 0)
                    ? "var(--bg-secondary)"
                    : "var(--accent-color)",
                color:
                  offset + limit >= (auditData?.total || 0)

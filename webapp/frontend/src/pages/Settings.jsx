          ...
          {tabs.map((tab) => (
            <button
              ...
              style={{
                ...
                border: "none",
                background:
                  tabIndex === tab.id ? "var(--surface)" : "transparent",
                color: tabIndex === tab.id ? "var(--text)" : "var(--text-2)",
                fontWeight:
                  tabIndex === tab.id ? "var(--w-semibold)" : "var(--w-medium)",
                fontSize: "var(--t-sm)",
                cursor: "pointer",
                borderBottom:
                  tabIndex === tab.id ? "2px solid var(--brand)" : "none",
              ...
              >
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      handleNotificationChange("alerts", e.target.checked)
                    }
                    style={{ display: "none" }}
                  />
                  <div

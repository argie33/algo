...
const RiskAnalytics = () => {
  const {
    ...
    loading: isLoading,
    error,
  } = useApiQuery(["risk-metrics"], () => api.get("/api/algo/risk-metrics"));
        ...
        <div className="page-head">
          <div>
            ...
            <div className="page-head-sub">
              Portfolio risk metrics and stress scenarios
            </div>
          </div>
        </div>
        <div
    ...
    <div className="main-content">
      ...
      {!hasData && !error && (
        ...
        >
          ...
          Risk metrics are not yet available. Data will appear after sufficient
          trading history.
        </div>
      )}
      ...
      >
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            >
              Potential loss under stress scenarios (market crash, liquidity
              crisis)
            </div>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            >
              {metrics.portfolio_beta !== null &&
              metrics.portfolio_beta !== undefined
        ...
        <div className="card-body">
          ...
          >
            <div>
              ...
              >
                The maximum loss expected 95% of the time. If VaR is 5%, there's
                a 5% chance of losing more than that in a given period.
              </div>
            </div>
            <div>
              <div
              ...
              >
                When VaR is exceeded, how much worse could it get? Measures tail
                risk — the severity of worst-case scenarios.
              </div>
            </div>
            <div>
              <div
              ...
              >
                Estimated loss during a crisis using historical stress
                scenarios. Shows how your portfolio performs when the market
                breaks.
              </div>
            </div>
            <div>
              ...
              >
                Beta &gt; 1 = more volatile than the market. Beta &lt; 1 = less
                volatile. Higher beta = higher risk but higher return potential.
              </div>
            </div>
          </div>
        </div>

...
export const ENDPOINT_SCHEMAS = {
  ...
  "/api/scores/stockscores": {
    ...
    paginationFields: ["limit", "offset", "total", "page"],
    decimalFields: [
      "composite_score",
      "quality_score",
      "momentum_score",
      ...
      "growth_score",
      "risk_score",
      "quality_inputs.return_on_equity_pct",
      "quality_inputs.return_on_assets_pct",
      "quality_inputs.return_on_invested_capital_pct",
      "quality_inputs.gross_profitability_pct",
      "quality_inputs.operating_profitability_pct",
      "quality_inputs.accruals_ratio_pct",
      "quality_inputs.margin_volatility",
      "quality_inputs.gross_margin_pct",
      "quality_inputs.operating_margin_pct",
      "quality_inputs.profit_margin_pct",
    ],
  },

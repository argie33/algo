...
/**
 * AWS Secrets Manager Diagnostic Script - Local Lambda Version
 * Uses existing Lambda dependencies
 */
    ...
    try {
        ...
        if (response.SecretString) {
            ...
            if (!response.SecretString.startsWith('{')) {
                ...
                console.log(`🔍 Actual first character: "${response.SecretString[0]}" (code: ${response.SecretString.charCodeAt(0)})`);
            }
        } else {

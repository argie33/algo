...
router.get("/analysis", async (req, res) => {
  try {
    ...
    console.log(`⚠️ Risk analysis requested for user: ${userId}, period: ${period}`);
...
router.get("/portfolio", async (req, res) => {
  try {
    ...
    console.log(`⚠️ Portfolio risk analysis requested - timeframe: ${timeframe}, risk_level: ${risk_level}, metrics: ${metrics}`);
...
router.get("/portfolio", async (req, res) => {
  try {
    ...
    console.log(`📊 Portfolio risk analysis requested, timeframe: ${timeframe}`);
...
router.get("/var", async (req, res) => {
  try {
    ...
    console.log(`📉 VaR analysis requested, confidence: ${confidence}%, timeframe: ${timeframe}`);

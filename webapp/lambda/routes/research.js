...
router.get("/", async (req, res) => {
  try {
    ...
    try {
      ...
      console.log(`✅ Found ${recommendationsResult.rows.length} analyst recommendations`);
    } catch (error) {
      console.log('❌ Analyst recommendations table not available:', error.message);
    ...
    research.sort((a, b) => new Date(b.published_at) - new Date(a.published_at));

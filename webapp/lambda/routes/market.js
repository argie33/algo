...
// DELETED: /api/market/sectors/performance - use /api/sectors/sectors-with-history instead

// DELETED: /api/market/industries - use /api/sectors/industries-with-history instead

// DELETED: /api/market/sectors - use /api/sectors/sectors-with-history instead
      ...
      data: {
        ...
        indicators: [
          ...
          // LAGGING ECONOMIC INDICATORS
          {
            ...
            unit: "Weeks",
            trend: indicators["UEMPMEAN"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["UEMPMEAN"] ? (Math.random() * 5 - 2.5).toFixed(2) : 0,
          ...
          },
          {
            ...
            unit: "%",
            trend: indicators["PRIME"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["PRIME"] ? (Math.random() * 0.5 - 0.25).toFixed(2) : 0,
          ...
          },
          {
            ...
            unit: "%",
            trend: indicators["MMNRNJ"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["MMNRNJ"] ? (Math.random() * 0.3 - 0.15).toFixed(2) : 0,
          ...
          },
          {
            ...
            unit: "Ratio",
            trend: indicators["ISITC"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["ISITC"] ? (Math.random() * 2 - 1).toFixed(2) : 0,
          ...
          },
          {
            ...
            unit: "Thousands",
            trend: indicators["TOTALSA"] ? (Math.random() > 0.5 ? "up" : "down") : "up",
            trendPercent: indicators["TOTALSA"] ? (Math.random() * 0.5 - 0.25).toFixed(2) : 0.25,
          ...
          },
          {
            ...
            unit: "Billions",
            trend: indicators["IMPGS"] ? (Math.random() > 0.5 ? "up" : "down") : "up",
            trendPercent: indicators["IMPGS"] ? (Math.random() * 3 - 1.5).toFixed(2) : 2,
          ...
          },
          {
            ...
            unit: "%",
            trend: indicators["LBMVRTQ"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["LBMVRTQ"] ? (Math.random() * 0.4 - 0.2).toFixed(2) : 0,
          ...
          // COINCIDENT/ADDITIONAL ECONOMIC INDICATORS
          {
            ...
            unit: "Index",
            trend: indicators["UMCSENT"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["UMCSENT"] ? (Math.random() * 5 - 2.5).toFixed(2) : 0,
          ...
          },
          {
            ...
            unit: "Billions",
            trend: indicators["RSXFS"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["RSXFS"] ? (Math.random() * 5 - 2.5).toFixed(2) : 0,
          ...
          },
          {
            ...
            unit: "%",
            trend: indicators["EMSRATIO"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["EMSRATIO"] ? (Math.random() * 5 - 2.5).toFixed(2) : 0,
          ...
          // NEW LEADING INDICATORS
          {
            ...
            unit: "%",
            trend: indicators["CIVPART"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["CIVPART"] ? (Math.random() * 2 - 1).toFixed(2) : 0,
          ...
          },
          {
            ...
            unit: "$/barrel",
            trend: indicators["DCOILWTICO"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["DCOILWTICO"] ? (Math.random() * 5 - 2.5).toFixed(2) : 0,
          ...
          },
          {
            ...
            unit: "%",
            trend: indicators["MORTGAGE30US"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["MORTGAGE30US"] ? (Math.random() * 0.5 - 0.25).toFixed(2) : 0,
          ...
          },
          {
            ...
            unit: "bps",
            trend: indicators["BAMLH0A0HYM2"] ? (Math.random() > 0.5 ? "up" : "down") : "stable",
            trendPercent: indicators["BAMLH0A0HYM2"] ? (Math.random() * 50 - 25).toFixed(2) : 0,

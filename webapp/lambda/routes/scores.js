  ...
  try {
    ...
    let stocksQuery = `
      SELECT
        ...
        roc_120d,
        mansfield_rs,
        -- Raw valuation inputs - extracted from value_inputs JSONB or NULL
        pe_ratio as stock_pe,
        (value_inputs->>'pb_ratio')::NUMERIC as stock_pb,
        (value_inputs->>'ps_ratio')::NUMERIC as stock_ps,
        (value_inputs->>'ev_ebitda')::NUMERIC as stock_ev_ebitda,
        (value_inputs->>'fcf_yield')::NUMERIC as stock_fcf_yield,
        (value_inputs->>'dividend_yield')::NUMERIC as stock_dividend_yield,
        (value_inputs->>'earnings_growth_pct')::NUMERIC as earnings_growth_pct,
        ...
        -- Positioning metrics - extracted from value_inputs JSONB or NULL
        (value_inputs->>'institutional_ownership')::NUMERIC as institutional_ownership,
        (value_inputs->>'insider_ownership')::NUMERIC as insider_ownership,
        (value_inputs->>'short_percent_of_float')::NUMERIC as short_percent_of_float,
        (value_inputs->>'short_ratio')::NUMERIC as short_ratio,
        (value_inputs->>'institution_count')::INT as institution_count,
        -- Quality INPUT metrics - extracted from value_inputs JSONB or NULL
        (value_inputs->>'return_on_equity_pct')::NUMERIC as return_on_equity_pct,
        (value_inputs->>'return_on_assets_pct')::NUMERIC as return_on_assets_pct,
        (value_inputs->>'gross_margin_pct')::NUMERIC as gross_margin_pct,
        (value_inputs->>'operating_margin_pct')::NUMERIC as operating_margin_pct,
        (value_inputs->>'profit_margin_pct')::NUMERIC as profit_margin_pct,
        (value_inputs->>'fcf_to_net_income')::NUMERIC as fcf_to_net_income,
        (value_inputs->>'operating_cf_to_net_income')::NUMERIC as operating_cf_to_net_income,
        (value_inputs->>'debt_to_equity')::NUMERIC as debt_to_equity,
        (value_inputs->>'current_ratio')::NUMERIC as current_ratio,
        (value_inputs->>'quick_ratio')::NUMERIC as quick_ratio,
        (value_inputs->>'earnings_surprise_avg')::NUMERIC as earnings_surprise_avg,
        (value_inputs->>'eps_growth_stability')::NUMERIC as eps_growth_stability,
        (value_inputs->>'payout_ratio')::NUMERIC as payout_ratio,
        -- Growth INPUT metrics - extracted from value_inputs JSONB or NULL
        (value_inputs->>'revenue_growth_3y_cagr')::NUMERIC as revenue_growth_3y_cagr,
        (value_inputs->>'eps_growth_3y_cagr')::NUMERIC as eps_growth_3y_cagr,
        (value_inputs->>'operating_income_growth_yoy')::NUMERIC as operating_income_growth_yoy,
        (value_inputs->>'roe_trend')::NUMERIC as roe_trend,
        (value_inputs->>'sustainable_growth_rate')::NUMERIC as sustainable_growth_rate,
        (value_inputs->>'fcf_growth_yoy')::NUMERIC as fcf_growth_yoy,
        (value_inputs->>'net_income_growth_yoy')::NUMERIC as net_income_growth_yoy,
        (value_inputs->>'gross_margin_trend')::NUMERIC as gross_margin_trend,
        (value_inputs->>'operating_margin_trend')::NUMERIC as operating_margin_trend,
        (value_inputs->>'net_margin_trend')::NUMERIC as net_margin_trend,
        (value_inputs->>'quarterly_growth_momentum')::NUMERIC as quarterly_growth_momentum,
        (value_inputs->>'asset_growth_yoy')::NUMERIC as asset_growth_yoy,
        -- Raw momentum INPUT metrics - extracted from value_inputs JSONB or NULL
        (value_inputs->>'momentum_12m_1')::NUMERIC as momentum_12m_1,
        (value_inputs->>'momentum_6m')::NUMERIC as momentum_6m,
        (value_inputs->>'momentum_3m')::NUMERIC as momentum_3m,
        (value_inputs->>'risk_adjusted_momentum')::NUMERIC as risk_adjusted_momentum,
        (value_inputs->>'price_vs_sma_50')::NUMERIC as price_vs_sma_50,
        (value_inputs->>'price_vs_sma_200')::NUMERIC as price_vs_sma_200,
        (value_inputs->>'price_vs_52w_high')::NUMERIC as price_vs_52w_high,
        (value_inputs->>'high_52w')::NUMERIC as high_52w,
        (value_inputs->>'volatility_12m')::NUMERIC as volatility_12m,
        -- Risk INPUT metrics - extracted from stability_inputs JSONB or NULL
        (stability_inputs->>'volatility_12m_pct')::NUMERIC as volatility_12m_pct,
        (stability_inputs->>'volatility_risk_component')::NUMERIC as volatility_risk_component,
        (stability_inputs->>'max_drawdown_52w_pct')::NUMERIC as max_drawdown_52w_pct,
        (stability_inputs->>'beta')::NUMERIC as beta

  ...
  try {
    ...
    const symbolQuery = `
      SELECT
        ...
        (value_inputs->>'stock_pb')::NUMERIC as stock_pb,
        (value_inputs->>'stock_ps')::NUMERIC as stock_ps,
        (value_inputs->>'stock_ev_ebitda')::NUMERIC as stock_ev_ebitda,
        ...
        (value_inputs->>'sector_pe')::NUMERIC as sector_pe,
        (value_inputs->>'sector_pb')::NUMERIC as sector_pb,
        (value_inputs->>'sector_ps')::NUMERIC as sector_ps,
        (value_inputs->>'sector_ev_ebitda')::NUMERIC as sector_ev_ebitda,
        (value_inputs->>'sector_fcf_yield')::NUMERIC as sector_fcf_yield,
        (value_inputs->>'sector_dividend_yield')::NUMERIC as sector_dividend_yield,
        NULL::NUMERIC as sector_debt_to_equity,
        (value_inputs->>'market_pe')::NUMERIC as market_pe,
        (value_inputs->>'market_pb')::NUMERIC as market_pb,
        (value_inputs->>'market_ps')::NUMERIC as market_ps,
        (value_inputs->>'market_fcf_yield')::NUMERIC as market_fcf_yield,
        (value_inputs->>'market_dividend_yield')::NUMERIC as market_dividend_yield,

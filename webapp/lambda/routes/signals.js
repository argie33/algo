...
const getStocksSignals = async (req, res) => {
  try {
    ...
    const actualColumns = useTechJoin ? `
      ...
      bsd.r_multiple_t1, bsd.r_multiple_t2, bsd.r_multiple_t3,
      bsd.target_t1_price, bsd.target_t2_price, bsd.target_t3_price,
      bsd.stop_method,
      bsd.exit_21ema_break, bsd.exit_50dma_light_volume, bsd.exit_50dma_heavy_volume, bsd.exit_power_trend_flag,
      bsd.distance_to_pivot_pct, bsd.base_count, bsd.distribution_days_4w,

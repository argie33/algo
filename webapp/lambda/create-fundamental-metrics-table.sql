-- Create fundamental_metrics table for AWS database
-- This table stores fundamental financial metrics for stocks
...
-- Insert sample data for major stocks
...
SELECT COUNT(*) as total_records FROM fundamental_metrics;
SELECT symbol, company_name, sector, industry FROM fundamental_metrics LIMIT 5;
...
CREATE TABLE IF NOT EXISTS buy_sell_daily (
    ...
    stoplevel REAL,
    inposition BOOLEAN,
    -- Swing Trading Metrics (27 total fields)
    selllevel REAL,
    target_price REAL,
    current_price REAL,
    risk_reward_ratio REAL,
    market_stage VARCHAR(50),
    stage_confidence INTEGER DEFAULT 0,
    substage VARCHAR(50),
    pct_from_ema_21 REAL,
    pct_from_sma_50 REAL,
    pct_from_sma_200 REAL,
    volume_ratio REAL,
    volume_analysis VARCHAR(50),
    entry_quality_score INTEGER,
    profit_target_8pct REAL,
    profit_target_20pct REAL,
    current_gain_loss_pct REAL,
    risk_pct REAL,
...
CREATE TABLE IF NOT EXISTS buy_sell_weekly (
    ...
    stoplevel REAL,
    inposition BOOLEAN,
    -- Swing Trading Metrics (same as daily)
    selllevel REAL,
    target_price REAL,
    current_price REAL,
    risk_reward_ratio REAL,
...
('AAPL', '2024-01-01', 65.4, 0.82, 0.75, 0.07, 2.1, 3.2, 45.2, 25.1, 18.7, 1.8, 125000, 0.15, 72.3, 9, 13, 0.5, 1.2, 180.25, 178.50, 175.80, 170.25, 165.90, 181.10, 179.85, 177.20, 174.50, 179.25, 184.00, 182.00, 176.50, 0.0, 0.0, '2024-01-01 09:30:00'),
('MSFT', '2024-01-01', 58.2, 1.45, 1.32, 0.13, 3.8, 4.5, 52.8, 28.4, 21.2, 2.1, 180000, 0.22, 68.9, 7, 11, 0.6, 1.5, 425.30, 422.80, 418.50, 410.25, 405.90, 426.10, 424.85, 421.20, 420.50, 425.25, 430.00, 428.00, 418.50, 0.0, 0.0, '2024-01-01 09:30:00'),
('GOOGL', '2024-01-01', 42.1, -0.25, -0.18, -0.07, -1.2, -2.1, 38.5, 22.8, 26.4, 1.5, 95000, -0.08, 45.6, 3, 5, 0.3, 0.8, 138.45, 136.20, 134.80, 132.25, 128.90, 139.10, 137.85, 135.20, 134.50, 137.25, 140.00, 140.50, 135.00, 0.0, 141.0, '2024-01-01 09:30:00'),
('TSLA', '2024-01-01', 72.8, 2.15, 1.85, 0.30, 8.2, 12.5, 48.9, 32.1, 19.8, 3.2, 210000, 0.35, 78.4, 11, 15, 0.8, 2.1, 255.75, 252.50, 248.80, 240.25, 235.90, 257.10, 254.85, 251.20, 248.50, 253.25, 258.00, 260.00, 246.50, 0.0, 0.0, '2024-01-01 09:30:00'),
('AMZN', '2024-01-01', 55.6, 0.95, 0.88, 0.07, 2.8, 4.1, 41.2, 24.6, 22.8, 1.9, 150000, 0.18, 62.3, 5, 8, 0.4, 1.1, 148.90, 146.80, 144.50, 140.25, 136.90, 149.60, 148.35, 146.70, 144.50, 147.25, 150.00, 151.00, 144.00, 0.0, 0.0, '2024-01-01 09:30:00')
ON CONFLICT DO NOTHING;

-- Insert stock_scores test data (matches loadstockscores.py schema)
INSERT INTO stock_scores (symbol, composite_score, momentum_score, value_score, quality_score, growth_score, positioning_score, sentiment_score, rsi, macd, sma_20, sma_50, volume_avg_30d, current_price, price_change_1d, price_change_5d, price_change_30d, volatility_30d, market_cap, pe_ratio, score_date, last_updated) VALUES
('AAPL', 85.2, 78.5, 68.3, 89.7, 82.4, 70.0, 70.0, 65.4, 0.82, 178.50, 175.80, 52000000, 180.25, 2.1, 8.5, 15.2, 18.7, 2750000000000, 28.5, '2024-01-01', '2024-01-01 09:30:00'),
('MSFT', 82.8, 75.2, 71.6, 85.4, 79.3, 70.0, 70.0, 58.2, 1.45, 422.80, 418.50, 28000000, 425.30, 3.2, 12.1, 22.3, 21.2, 3050000000000, 32.1, '2024-01-01', '2024-01-01 09:30:00'),
('GOOGL', 74.5, 62.8, 82.1, 74.9, 71.5, 70.0, 70.0, 42.1, -0.25, 136.20, 134.80, 31000000, 138.45, -1.2, -3.8, 5.4, 26.4, 1680000000000, 22.3, '2024-01-01', '2024-01-01 09:30:00'),
('TSLA', 91.3, 95.2, 76.4, 88.9, 93.8, 70.0, 70.0, 72.8, 2.15, 252.50, 248.80, 67000000, 255.75, 8.2, 25.1, 45.6, 32.1, 780000000000, 45.2, '2024-01-01', '2024-01-01 09:30:00'),
('AMZN', 77.6, 68.4, 74.2, 80.1, 75.6, 70.0, 70.0, 55.6, 0.95, 146.80, 144.50, 35000000, 148.90, 2.8, 9.2, 18.7, 22.8, 1480000000000, 38.7, '2024-01-01', '2024-01-01 09:30:00'),
('NVDA', 94.8, 98.5, 72.1, 91.4, 96.7, 70.0, 70.0, 78.3, 3.25, 865.40, 852.20, 45000000, 875.50, 12.5, 28.9, 67.8, 35.6, 2150000000000, 52.8, '2024-01-01', '2024-01-01 09:30:00'),
('META', 79.2, 82.1, 69.8, 76.4, 77.8, 70.0, 70.0, 61.8, 1.85, 485.20, 478.90, 18000000, 492.30, 5.8, 15.4, 31.2, 28.5, 1250000000000, 24.6, '2024-01-01', '2024-01-01 09:30:00'),
('NFLX', 71.8, 69.5, 65.4, 75.2, 68.9, 70.0, 70.0, 48.6, 0.68, 445.80, 441.20, 8500000, 452.10, 3.4, 8.7, 12.5, 31.8, 195000000000, 28.9, '2024-01-01', '2024-01-01 09:30:00')

/**
 * Settings Integration Tests - REAL DATA ONLY
 * Tests settings endpoints with REAL database connection and REAL loaded data
...
describe("Settings Routes - Real Data Validation", () => {
  beforeAll(async () => {

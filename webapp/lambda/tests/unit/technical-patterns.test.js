...
describe("Technical Pattern Recognition Tests", () => {
  ...
  const mockPriceData = [
    { close: 150.0, high: 152.0, low: 149.0, date: "2024-01-01" },
    { close: 148.0, high: 151.0, low: 147.5, date: "2024-01-02" },
    { close: 145.0, high: 149.0, low: 144.0, date: "2024-01-03" },
    { close: 147.0, high: 148.5, low: 144.5, date: "2024-01-04" },
    { close: 149.0, high: 150.0, low: 146.5, date: "2024-01-05" },
    { close: 152.0, high: 153.0, low: 149.5, date: "2024-01-06" },
    { close: 154.0, high: 155.0, low: 151.0, date: "2024-01-07" },
    { close: 153.0, high: 155.5, low: 152.0, date: "2024-01-08" },
  ];
  ...
  describe("GET /technical/patterns/:symbol - Pattern Detection", () => {
    it("should detect double bottom pattern", async () => {
      ...
      const mockDoubleBottomData = [
        { close: 150.0, high: 152.0, low: 149.0, date: "2024-01-01" },
        { close: 145.0, high: 148.0, low: 144.0, date: "2024-01-02" }, // First bottom
        { close: 148.0, high: 150.0, low: 147.0, date: "2024-01-03" },
        { close: 150.0, high: 152.0, low: 149.0, date: "2024-01-04" },
        { close: 147.0, high: 149.0, low: 146.0, date: "2024-01-05" },
        { close: 144.5, high: 147.0, low: 143.5, date: "2024-01-06" }, // Second bottom (similar level)
        { close: 148.0, high: 150.0, low: 147.0, date: "2024-01-07" },
        { close: 152.0, high: 154.0, low: 151.0, date: "2024-01-08" },
      ];
      ...
      const doubleBottomPattern = response.body.patterns.find(
    ...
    it("should detect cup and handle pattern", async () => {
      ...
      const mockCupHandleData = [
        { close: 160.0, high: 162.0, low: 159.0, date: "2024-01-01" }, // Peak
        { close: 155.0, high: 158.0, low: 154.0, date: "2024-01-02" }, // Down
        { close: 150.0, high: 153.0, low: 149.0, date: "2024-01-03" }, // Cup bottom
        { close: 152.0, high: 154.0, low: 151.0, date: "2024-01-04" }, // Up
        { close: 158.0, high: 160.0, low: 157.0, date: "2024-01-05" }, // Near peak
        { close: 156.0, high: 158.0, low: 155.0, date: "2024-01-06" }, // Handle down
        { close: 157.0, high: 158.5, low: 156.0, date: "2024-01-07" }, // Handle up
        { close: 161.0, high: 163.0, low: 160.0, date: "2024-01-08" }, // Breakout
      ];
      ...
      const cupHandlePattern = response.body.patterns.find(
        (p) => p.type === "cup_and_handle"
      );
      if (cupHandlePattern) {
    ...
    it("should detect head and shoulders pattern", async () => {
      ...
      const mockHeadShouldersData = [
        { close: 150.0, high: 152.0, low: 149.0, date: "2024-01-01" }, // Left shoulder
        { close: 148.0, high: 150.0, low: 147.0, date: "2024-01-02" }, // Valley
        { close: 155.0, high: 157.0, low: 154.0, date: "2024-01-03" }, // Head
        { close: 152.0, high: 154.0, low: 151.0, date: "2024-01-04" }, // Valley
        { close: 149.0, high: 151.0, low: 148.0, date: "2024-01-05" }, // Right shoulder
        { close: 147.0, high: 149.0, low: 146.0, date: "2024-01-06" }, // Breakdown
        { close: 144.0, high: 146.0, low: 143.0, date: "2024-01-07" }, // Continuation
        { close: 142.0, high: 144.0, low: 141.0, date: "2024-01-08" }, // Further down
      ];
      ...
      const headShouldersPattern = response.body.patterns.find(
    ...
    it("should detect ascending triangle pattern", async () => {
      ...
      const mockTriangleData = [
        { close: 150.0, high: 155.0, low: 149.0, date: "2024-01-01" }, // Resistance at 155
        { close: 152.0, high: 155.0, low: 151.0, date: "2024-01-02" }, // Higher low, same high
        { close: 154.0, high: 155.0, low: 153.0, date: "2024-01-03" }, // Higher low, same high
        { close: 153.0, high: 155.0, low: 152.5, date: "2024-01-04" }, // Higher low, same high
        { close: 154.5, high: 155.0, low: 154.0, date: "2024-01-05" }, // Higher low, same high
        { close: 156.0, high: 157.0, low: 155.0, date: "2024-01-06" }, // Breakout above resistance
        { close: 158.0, high: 159.0, low: 157.0, date: "2024-01-07" }, // Continuation
        { close: 160.0, high: 161.0, low: 159.0, date: "2024-01-08" }, // Further up
      ];
      ...
      const trianglePattern = response.body.patterns.find(
        (p) => p.type === "ascending_triangle"
      );
      if (trianglePattern) {
    ...
    it("should validate pattern confidence scores", async () => {
      ...
      if (response.body.summary.average_confidence !== null) {
        expect(response.body.summary.average_confidence).toBeGreaterThanOrEqual(
          0
        );
    ...
    it("should handle insufficient data gracefully", async () => {
      ...
      const mockLimitedData = [
        { close: 150.0, high: 152.0, low: 149.0, date: "2024-01-01" },
        { close: 151.0, high: 153.0, low: 150.0, date: "2024-01-02" },
      ];
    ...
    it("should return fallback patterns on database errors", async () => {
      ...
      expect(
        response.body.fallback === true || response.body.patterns.length > 0
      ).toBe(true);
    });
    ...
    it("should calculate market sentiment correctly", async () => {
      ...
      expect(summary.total_patterns).toBe(
    ...
    it("should handle table not exists scenario", async () => {
      ...
      expect(response.body.patterns).toBeInstanceOf(Array);
      expect(response.body.summary.market_sentiment).toMatch(
        /^(bullish|bearish)$/
      );
    });
  });
  ...
  describe("Pattern Detection Algorithm Validation", () => {
    it("should detect multiple patterns in complex price action", async () => {
      ...
      const mockComplexData = [
        { close: 100.0, high: 102.0, low: 99.0, date: "2024-01-01" },
        { close: 95.0, high: 98.0, low: 94.0, date: "2024-01-02" }, // First bottom
        { close: 98.0, high: 100.0, low: 97.0, date: "2024-01-03" },
        { close: 105.0, high: 107.0, low: 104.0, date: "2024-01-04" },
        { close: 102.0, high: 104.0, low: 101.0, date: "2024-01-05" },
        { close: 96.0, high: 98.5, low: 95.5, date: "2024-01-06" }, // Second bottom
        { close: 99.0, high: 101.0, low: 98.0, date: "2024-01-07" },
        { close: 103.0, high: 105.0, low: 102.0, date: "2024-01-08" },
        { close: 107.0, high: 109.0, low: 106.0, date: "2024-01-09" },
        { close: 110.0, high: 112.0, low: 109.0, date: "2024-01-10" },
      ];
      ...
      if (response.body.patterns.length > 1) {
        for (let i = 1; i < response.body.patterns.length; i++) {
          expect(
            response.body.patterns[i - 1].confidence
    ...
    it("should validate pattern timing calculations", async () => {
      ...
      response.body.patterns.forEach((pattern) => {
        ...
        expect(new Date(pattern.detected_at).toString()).not.toBe(
          "Invalid Date"
        );
      });
    });
  ...
  describe("Error Handling and Edge Cases", () => {
    ...
    it("should handle malformed date data", async () => {
      const mockBadDateData = [
        { close: 150.0, high: 152.0, low: 149.0, date: "invalid-date" },
        { close: 151.0, high: 153.0, low: 150.0, date: null },
        { close: 152.0, high: 154.0, low: 151.0, date: "2024-01-03" },
      ];

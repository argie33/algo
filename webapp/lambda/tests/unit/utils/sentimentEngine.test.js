...
describe('SentimentEngine', () => {
  ...
  describe('analyzeSentiment', () => {
    test('should analyze positive sentiment text', async () => {
      const positiveText = 'This is great news! The stock is bullish and shows excellent gains.';
    ...
    test('should analyze negative sentiment text', async () => {
      const negativeText = 'This is terrible news. The stock is bearish with poor performance and losses.';
    ...
    test('should analyze neutral text', async () => {
      ...
      const result = await sentimentEngine.analyzeSentiment(neutralText, 'TSLA');
    ...
    test('should analyze mixed sentiment text', async () => {
      const mixedText = 'Good profits this quarter but bad outlook for next year.';
    ...
    test('should calculate confidence based on sentiment word density', async () => {
      const highDensityText = 'good great excellent positive bullish profit success';
      const lowDensityText = 'The quarterly earnings report was released today and it shows good results overall.';
    ...
    test('should handle non-string input', async () => {
      ...
      const objectResult = await sentimentEngine.analyzeSentiment({ text: 'hello' });
      const arrayResult = await sentimentEngine.analyzeSentiment(['hello', 'world']);
  ...
  describe('integration tests', () => {
    ...
    test('should handle complex real-world text samples', async () => {
      ...
      const result = await sentimentEngine.analyzeSentiment(complexText, 'AAPL');

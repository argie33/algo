...
describe("Backtest Store", () => {
  ...
  describe("addStrategy", () => {
    ...
    test("should preserve existing strategies when adding", () => {
      ...
      expect(savedStrategies[1]).toEqual({
        ...newStrategy,
        id: "1234567890123",
      });
    });
    ...
    test("should handle load/save errors during add", () => {
      ...
      expect(() => backtestStore.addStrategy(newStrategy)).toThrow(
        "Load error"
      );
    });
  });
  ...
  describe("Edge Cases", () => {
    test("should handle null and undefined inputs", () => {
      ...
      expect(() => backtestStore.addStrategy(null)).toThrow(
        "Cannot set properties of null"
      );

      // Adding undefined strategy should throw error
      expect(() => backtestStore.addStrategy(undefined)).toThrow(

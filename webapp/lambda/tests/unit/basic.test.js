...
describe('Lambda Backend - Basic Functionality Tests', () => {
  ...
  describe('Environment Configuration', () => {
    test('should handle missing environment variables gracefully', () => {
      ...
      if (originalCognitoPoolId) process.env.COGNITO_USER_POOL_ID = originalCognitoPoolId;
      if (originalCognitoClientId) process.env.COGNITO_CLIENT_ID = originalCognitoClientId;
    });
  });

const { runContractTest, runSiteFunctionalityTests, API_CONTRACTS } = require('./contract-test-runner');
...
describe('API Contract Tests', () => {
  ...
  describe('Critical Endpoints', () => {
    ...
    test('Database connectivity contract', async () => {
      const result = await runContractTest('GET /api/diagnostics/database-connectivity', baseURL);
      expect(result).toBe(true);
    });
  });

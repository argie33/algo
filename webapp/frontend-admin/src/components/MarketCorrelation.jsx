                ...
                <Box sx={{ p: 2, bgcolor: "grey.50", borderRadius: 1 }}>
                  ...
                  <Typography variant="h6" sx={{ fontWeight: 600 }}>
                    {statistics.avg_correlation !== null
                      ? parseFloat(statistics.avg_correlation).toFixed(2)
                      : "N/A"}
                  </Typography>
                </Box>
                ...
                <Box sx={{ p: 2, bgcolor: "grey.50", borderRadius: 1 }}>
                  ...
                  <Typography variant="h6" sx={{ fontWeight: 600 }}>
                    {statistics.max_correlation?.value !== null
                      ? parseFloat(statistics.max_correlation.value).toFixed(2)
                      : "N/A"}
                ...
                <Box sx={{ p: 2, bgcolor: "grey.50", borderRadius: 1 }}>
                  ...
                  <Typography variant="h6" sx={{ fontWeight: 600 }}>
                    {statistics.min_correlation?.value !== null
                      ? parseFloat(statistics.min_correlation.value).toFixed(2)
                      : "N/A"}
                ...
                <Box sx={{ p: 2, bgcolor: "grey.50", borderRadius: 1 }}>
                  ...
                  <Typography variant="h6" sx={{ fontWeight: 600 }}>
                    {analysis?.diversification_score !== null
                      ? parseFloat(analysis.diversification_score).toFixed(1)
                      : "N/A"}
                  </Typography>
                </Box>

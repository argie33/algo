      ...
      const data = await dataCache.get(
        ...
        {},
        {
          ...
          fetchFunction: async () => {
            ...
            // ⛔ FIXED: Removed Math.random() generated fake index data
            // Market indices should be fetched from real market data API (Yahoo Finance, etc.)
            // For now, return empty array instead of fake data
            const indices = []; // TODO: Fetch real market index data from API

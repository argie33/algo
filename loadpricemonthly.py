#!/usr/bin/env python3
"""
Monthly Price Loader - Optimal Pattern.

Demonstrates OptimalLoader with monthly aggregation.
Inherits watermarks, dedup, multi-source routing, and bulk COPY.

Run:
    python3 loadpricemonthly.py [--symbols AAPL,MSFT] [--parallelism 4]
"""
...
def main():
    parser = argparse.ArgumentParser(description="Optimal price_monthly loader")

#!/usr/bin/env python3
"""
Sec Filings Loader - Optimal Pattern.

Inherits watermarks, dedup, multi-source routing, parallelism, and bulk COPY.

Run:
    python3 loadsecfilings.py [--symbols AAPL,MSFT] [--parallelism 8]
"""
...
class SecFilingsLoader(OptimalLoader):
...
def main():
    parser = argparse.ArgumentParser(description="Optimal sec_filings loader")

...
def test_yfinance_methods():
    ...
    try:
        ...
        try:
            ...
            print(
                f"✓ ticker.financials: {type(data)}, shape: {data.shape if data is not None and hasattr(data, 'shape') else 'N/A'}"
            )
        ...
        try:
            ...
            print(
                f"✓ ticker.quarterly_financials: {type(data)}, shape: {data.shape if data is not None and hasattr(data, 'shape') else 'N/A'}"
            )
            if data is not None and not data.empty:
        ...
        try:
            ...
            print(
                f"✓ ticker.balance_sheet: {type(data)}, shape: {data.shape if data is not None and hasattr(data, 'shape') else 'N/A'}"
            )
        except Exception as e:
        ...
        try:
            ...
            print(
                f"✓ ticker.quarterly_balance_sheet: {type(data)}, shape: {data.shape if data is not None and hasattr(data, 'shape') else 'N/A'}"
            )
        except Exception as e:
        ...
        try:
            ...
            print(
                f"✓ ticker.cashflow: {type(data)}, shape: {data.shape if data is not None and hasattr(data, 'shape') else 'N/A'}"
            )
        except Exception as e:
        ...
        try:
            ...
            print(
                f"✓ ticker.quarterly_cashflow: {type(data)}, shape: {data.shape if data is not None and hasattr(data, 'shape') else 'N/A'}"
            )
        except Exception as e:
        ...
        for method in newer_methods:
            try:
                ...
                print(
                    f"✓ ticker.{method}: {type(data)}, shape: {data.shape if data is not None and hasattr(data, 'shape') else 'N/A'}"
                )

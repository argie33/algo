...
def _filter_by_industry(
    ...
    both unchanged when industry_group is None. Same helper as fama_macbeth_quality_factors.py's
    own _filter_by_industry - kept per-module (not shared) since each module's `fund` schema

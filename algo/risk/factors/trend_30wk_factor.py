    ...
    def calculate(self, eval_date: Any, cur: Any) -> dict[str, Any]:
        ...
        try:
            ...
            if not current_row or current_row[0] is None:
                return {"score": 50, "reason": "No SPY price data available", "error": "missing_data"}
            ...
            if not ma_row or ma_row[0] is None:
                return {"score": 50, "reason": "Insufficient data for 30-week MA", "error": "insufficient_data"}
            ...
            logger.error(f"Failed to calculate 30-week trend factor: {e}")

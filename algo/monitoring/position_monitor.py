...
# Imported here (not at module top) because position_corporate_actions.py itself imports
# PositionValidationError from this module - placing this import before that class exists
# would be a circular-import failure.
from algo.monitoring.position_corporate_actions import CorporateActionsMixin  # noqa: E402


class PositionMonitor(CorporateActionsMixin):

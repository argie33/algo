...
class AlgoConfig:
    ...
    DEFAULTS = {
        ...
        "pyramid_add_1_gain_pct": (
            "2.0",
            "float",
            "Gain threshold for first add-on",
            "Entry Rules",
        ),
        "pyramid_add_2_gain_pct": (
            "4.0",
            "float",
            "Gain threshold for second add-on",
            "Entry Rules",
        ),
        "pyramid_split_pct": (
            "50.0",
            "float",
            "Position size percentage per add-on",
            "Entry Rules",
        ),
        ...
        "signal_max_data_age_days": (
            "3",
            "int",
            "Maximum age of signal data (days)",
            "Signal Quality",
        ),
        # Data Staleness Thresholds
        "stale_loader_threshold_minutes": (
            "60",
            "int",
            "Alert if loader data stale (minutes)",
            "Data Quality",
        ),
        "stale_order_alert_minutes": (
            "30",
            "int",
            "Alert if order pending (minutes)",
            "Data Quality",
        ),
        "stale_order_auto_cancel_minutes": (
            "120",
            "int",
            "Auto-cancel stale orders (minutes)",
            "Data Quality",
        ),
        ...
        "swing_weight_setup": (
            "25",
            "int",
            "Setup quality weight percentage",
            "Scoring",
        ),
        "swing_weight_trend": (
            "20",
            "int",
            "Trend quality weight percentage",
            "Scoring",
        ),
        # API Configuration
        "alpaca_api_base_url": (
        ...
        "retry_count_aaii_sentiment": (
            "3",
            "int",
            "Retry count for AAII sentiment calls",
            "API Configuration",
        ),

...
# Regime-based swing score requirements
REGIME_MIN_SWING_SCORE_CONFIRMED_UPTREND = 55
REGIME_MIN_SWING_SCORE_UPTREND_UNDER_PRESSURE = 62
REGIME_MIN_SWING_SCORE_CAUTION = 70
REGIME_MIN_SWING_SCORE_CORRECTION = 80

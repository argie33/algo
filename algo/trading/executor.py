...
class TradeExecutor:
    ...
    def _sync_bracket_stop_loss(self, alpaca_order_id: str | None, new_stop_price: float) -> dict[str, Any]:
        return self.order_manager.sync_bracket_stop_loss(alpaca_order_id, new_stop_price)

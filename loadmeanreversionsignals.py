#!/usr/bin/env python3
"""
Mean Reversion Signals Loader - Optimal Pattern.

Inherits watermarks, dedup, multi-source routing, parallelism, and bulk COPY.

Run:
    python3 loadmeanreversionsignals.py [--symbols AAPL,MSFT] [--parallelism 8]
"""
...
class MeanReversionSignalsLoader(OptimalLoader):
    table_name = "mean_reversion_signals"
...
def main():
    parser = argparse.ArgumentParser(description="Optimal mean_reversion_signals loader")
    ...
    loader = MeanReversionSignalsLoader()
    try:

...
def get_db_config():
    ...
    Tries AWS Secrets Manager first, falls back to environment variables for local dev.
    """
    ...
    if aws_region and db_secret_arn:
        try:
            ...
            logging.warning(f"AWS Secrets Manager failed: {e}. Falling back to environment variables.")

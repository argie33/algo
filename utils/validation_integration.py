...
QUICK START:
    ...
    from utils.validation_integration import get_validators
...
(1) Simple type validation:
    from utils.validation_framework import TypeValidator
    validator = TypeValidator('float', min_val=0.0)
    result = validator.validate(45.50)

(2) Schema validation:
    from utils.validation_framework import SchemaValidator, TypeValidator
...
(3) List validation:
    from utils.validation_framework import ListValidator, PhaseValidator
...
from utils.validation_framework import ValidatorRegistry, get_global_registry
from utils.domain_validators import create_default_registry

...
Provides both live API refresh capability and fallback hardcoded mappings.
"""
...
class TickerCache:
    ...
    def __init__(
        ...
        self._fallback_ticker_timestamp = "2025-02-01"
    ...
    def symbol_to_cik(self, symbol: str) -> Optional[str]:
        ...
        if symbol.upper() in _FALLBACK_TICKERS:
            ...
            return _FALLBACK_TICKERS[symbol.upper()]

        logger.debug(
            f"Unknown symbol {symbol} — not in API cache or fallback ({self._fallback_ticker_timestamp})"
        )
        return None

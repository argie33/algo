...
# Imported here (not at module top) because sec_statements_aggregate.py itself imports the
# constants/function defined above from this module - placing this import before they exist
# would be a circular-import failure. By this point in the file, everything
# sec_statements_aggregate.py needs from here has already been defined.
# _to_snake is re-exported (several tests import it from this module's original path).
from utils.external.sec_statements_aggregate import _aggregate_concepts, _to_snake  # noqa: E402, F401

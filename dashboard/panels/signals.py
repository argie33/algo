...
def panel_signals_expanded(sig: Any, sig_eval: Any = None, scores: Any = None) -> Panel | None:
    ...
    if top_scores:
        ...
        sig_tbl.add_column("Val", justify="right", no_wrap=True)
        sig_tbl.add_column("Grwth", justify="right", no_wrap=True)
        sig_tbl.add_column("Stab", justify="right", no_wrap=True)
        sig_tbl.add_column("Pos", justify="right", no_wrap=True)
        sig_tbl.add_column("RS%", justify="right", no_wrap=True)
        sig_tbl.add_column("Price", justify="right", no_wrap=True)

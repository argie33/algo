...
def panel_signals_expanded(sig: Any, sig_eval: Any = None) -> Panel | None:
    ...
    if valid_buy_sigs:
        ...
        sig_tbl.add_column("ATR1.5x", justify="right", no_wrap=True, min_width=7)
        sig_tbl.add_column("ATR3x", justify="right", no_wrap=True, min_width=7)
        sig_tbl.add_column("ATR4.5x", justify="right", no_wrap=True, min_width=7)

...
def _build_calendar_rows(econ_cal: Any) -> list[Text | Rule]:
    ...
    for ev in valid_cal[:6]:
        ...
        if ed_raw:
            ...
            logger.warning(
                f"Economic calendar event '{event_id}': event_date field missing from API response - will display as '--'"
            )
...
def panel_economic_pulse(eco: Any, econ_cal: Any = None) -> Panel | None:  # noqa: C901
    ...
    t2 = safe_float(indicators.get("t2"), default=None)
    t3m = safe_float(indicators.get("t3m"), default=None)
    t6m = safe_float(indicators.get("t6m"), default=None)
    yc10_2 = safe_float(indicators.get("yc_10_2"), default=None)
    yc10_3m = safe_float(indicators.get("yc_10_3m"), default=None)
    hy = safe_float(indicators.get("hy"), default=None)
    ig = safe_float(indicators.get("ig"), default=None)
    oil = safe_float(indicators.get("oil"), default=None)
    nfci = safe_float(indicators.get("nfci"), default=None)
    fed_funds = safe_float(indicators.get("fed_funds"), default=None)
    cpi_yoy = safe_float(indicators.get("cpi_yoy"), default=None)
    unrate = safe_float(indicators.get("unrate"), default=None)
    be10 = safe_float(indicators.get("be10"), default=None)
    be5 = safe_float(indicators.get("be5"), default=None)
    dxy = safe_float(indicators.get("dxy"), default=None)
    mortgage = safe_float(indicators.get("mortgage"), default=None)
    umcsent = safe_float(indicators.get("umcsent"), default=None)

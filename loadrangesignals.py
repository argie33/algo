#!/usr/bin/env python3
"""
Range Signals Loader - Optimal Pattern.

Inherits watermarks, dedup, multi-source routing, parallelism, and bulk COPY.

Run:
    python3 loadrangesignals.py [--symbols AAPL,MSFT] [--parallelism 8]
"""
...
class RangeSignalsLoader(OptimalLoader):
    table_name = "range_signals"
...
def main():
    parser = argparse.ArgumentParser(description="Optimal range_signals loader")

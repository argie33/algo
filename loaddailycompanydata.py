            ...
            try:
                ...
                """,
                    (
                        ...
                        safe_float(info.get("dividendYield"), max_val=100, min_val=0),
                        safe_float(info.get("fiveYearAvgDividendYield"), max_val=100, min_val=0),
                        safe_int(info.get("exDividendDate")),
                        safe_float(info.get("trailingAnnualDividendRate"), max_val=9999.99),
                        safe_float(info.get("trailingAnnualDividendYield"), max_val=100, min_val=0),
                        ...
                        safe_float(info.get("heldPercentInsiders"), max_val=100, min_val=0),
                        safe_float(info.get("heldPercentInstitutions"), max_val=100, min_val=0),

...
# Trigger deploy-app-stocks workflow test - loadinfo update v24 - simplified Dockerfile to match symbols
import sys
...
if __name__ == "__main__":
    ...
    try:
        ...
        logging.info("🔄 This is loadinfo update v17 - match stocksymbols exactly")
        ...
        logging.info(f"🚀 Deployment successful - Script version: loadinfo update v17")

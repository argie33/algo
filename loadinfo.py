        ...
        for yq_sym, orig_sym in mapping.items():
            ...
            try:
                ...
                """, (
                    ...
                    info.get('enterpriseToEbitda'),                    info.get('totalRevenue'), info.get('netIncome'),
                    info.get('ebitda'), info.get('grossProfit'),
                    info.get('trailingEps'), info.get('forwardEps'),
                    info.get('epsCurrentYear'), info.get('priceEpsCurrentYear'),

...
def _run_prepare(now: datetime, technical_rows: list) -> StockScoresLoader:
    # Empty-list stand-ins for the liquidity-floor config lookup (min_stock_price/
    # min_adv_dollars, added 2026-09-15) plus quality/growth/value/stability/liquidity/
    # quarantine/momentum (queried, in order, before the technical_cache query this test

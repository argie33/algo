...
just on two different real unit bases. The ratio held at ~100x across 3 separate fiscal
years (99.24x/100.00x/100.04x), the signature of a fixed real-world ADS ratio, unlike
NRC's one-off ~96.53x scale error (3.5% away from the nearest clean ratio candidate, 100)
which must still be rejected unchanged.
"""

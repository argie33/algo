...
def _load_scheduler_module():
    spec = importlib.util.spec_from_file_location(
        "local_loader_scheduler_under_test_reaped", REPO_ROOT / "scripts" / "local_loader_scheduler.py"
    )
...
class TestReapedFailuresDoNotDeadlock:
    def test_reaped_only_failures_do_not_skip_the_loader(self):
    ...
    def test_genuine_repeated_failures_still_skip_the_loader(self):
    ...
    def test_reaped_failures_below_threshold_are_unaffected(self):

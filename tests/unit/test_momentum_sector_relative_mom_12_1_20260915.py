...
def _row(
    ...
    momentum_12m, volatility_252d, sector, is_foreign_private_issuer, momentum_6m, market_cap
    (appended as the trailing column, 2026-09-17 - market-cap-weighted z-scoring per MSCI's real
    formula). rsi_14/macd/sma_50/sma_200/close/momentum_3m were dropped from the query entirely
    (2026-09-16) - the recompute never scored them, only passed them through unused."""
    return (
        symbol,
        momentum_score,
        composite_score,

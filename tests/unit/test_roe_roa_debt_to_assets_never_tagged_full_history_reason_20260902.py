...
class _FakeCursor:
    ...
    def fetchall(self):
        ...
        # annual_balance_sheet+stockholders_equity (joined against etf_symbols, no ROW_NUMBER())
        # and was otherwise indistinguishable from this fixture's own never-tagged-equity query.
        if (

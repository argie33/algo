...
def test_admin_rate_limit_with_malformed_user_id():
    ...
    # Test with list
    try:
        allowed, msg = check_admin_rate_limit(["user"], endpoint, 3, 1)
        assert isinstance(allowed, bool)
    except (TypeError, AttributeError):
        pass
...
def test_admin_rate_limit_with_malformed_endpoint():
    ...
    try:
        allowed, msg = check_admin_rate_limit(user_id, 12345, 3, 1)
        assert isinstance(allowed, bool)
    except (TypeError, AttributeError):
        pass
...
def test_admin_rate_limit_with_negative_values():
    ...
    try:
        allowed, msg = check_admin_rate_limit(user_id, endpoint, 0, 1)
        assert isinstance(allowed, bool)
...
def test_public_rate_limit_with_malformed_endpoint():
    ...
    # Test with int
    try:
        allowed, msg = check_public_rate_limit(12345, 3, 1)
        assert isinstance(allowed, bool)
    except (TypeError, AttributeError):
        pass

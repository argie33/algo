...
from utils.rate_limiting import (
    check_admin_rate_limit, ADMIN_RATE_LIMITS,
    check_public_rate_limit, PUBLIC_RATE_LIMITS,
    _admin_rate_limits, _public_rate_limits
)
...
def test_different_users_independent():
    ...
    allowed, msg = check_admin_rate_limit('user_2', endpoint, max_requests=3, window_seconds=60)
